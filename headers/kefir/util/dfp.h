...
kefir_dfp_decimal32_t kefir_dfp_decimal32_from_float(kefir_float32_t);
kefir_dfp_decimal32_t kefir_dfp_decimal32_from_double(kefir_float64_t);
kefir_dfp_decimal32_t kefir_dfp_decimal32_from_long_double(kefir_long_double_t);
kefir_dfp_decimal64_t kefir_dfp_decimal64_from_float(kefir_float32_t);
kefir_dfp_decimal64_t kefir_dfp_decimal64_from_double(kefir_float64_t);
kefir_dfp_decimal64_t kefir_dfp_decimal64_from_long_double(kefir_long_double_t);
kefir_dfp_decimal128_t kefir_dfp_decimal128_from_float(kefir_float32_t);
kefir_dfp_decimal128_t kefir_dfp_decimal128_from_double(kefir_float64_t);
...
kefir_bool_t kefir_dfp_decimal32_not_equals(kefir_dfp_decimal32_t, kefir_dfp_decimal32_t);
kefir_bool_t kefir_dfp_decimal64_not_equals(kefir_dfp_decimal64_t, kefir_dfp_decimal64_t);
kefir_bool_t kefir_dfp_decimal128_not_equals(kefir_dfp_decimal128_t, kefir_dfp_decimal128_t);
kefir_bool_t kefir_dfp_decimal32_greater(kefir_dfp_decimal32_t, kefir_dfp_decimal32_t);
kefir_bool_t kefir_dfp_decimal64_greater(kefir_dfp_decimal64_t, kefir_dfp_decimal64_t);
kefir_bool_t kefir_dfp_decimal128_greater(kefir_dfp_decimal128_t, kefir_dfp_decimal128_t);
kefir_bool_t kefir_dfp_decimal32_greater_or_equal(kefir_dfp_decimal32_t, kefir_dfp_decimal32_t);
kefir_bool_t kefir_dfp_decimal64_greater_or_equal(kefir_dfp_decimal64_t, kefir_dfp_decimal64_t);
kefir_bool_t kefir_dfp_decimal128_greater_or_equal(kefir_dfp_decimal128_t, kefir_dfp_decimal128_t);
kefir_bool_t kefir_dfp_decimal32_less(kefir_dfp_decimal32_t, kefir_dfp_decimal32_t);
kefir_bool_t kefir_dfp_decimal64_less(kefir_dfp_decimal64_t, kefir_dfp_decimal64_t);
kefir_bool_t kefir_dfp_decimal128_less(kefir_dfp_decimal128_t, kefir_dfp_decimal128_t);
kefir_bool_t kefir_dfp_decimal32_less_or_equal(kefir_dfp_decimal32_t, kefir_dfp_decimal32_t);
kefir_bool_t kefir_dfp_decimal64_less_or_equal(kefir_dfp_decimal64_t, kefir_dfp_decimal64_t);
kefir_bool_t kefir_dfp_decimal128_less_or_equal(kefir_dfp_decimal128_t, kefir_dfp_decimal128_t);
