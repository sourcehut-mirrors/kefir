...
struct kefir_softfloat_complex_float kefir_softfloat_complex_float_mul(struct kefir_softfloat_complex_float,
                                                                       struct kefir_softfloat_complex_float);
struct kefir_softfloat_complex_double kefir_softfloat_complex_double_mul(struct kefir_softfloat_complex_double,
                                                                         struct kefir_softfloat_complex_double);
struct kefir_softfloat_complex_long_double kefir_softfloat_complex_long_double_mul(
    struct kefir_softfloat_complex_long_double, struct kefir_softfloat_complex_long_double);
struct kefir_softfloat_complex_float kefir_softfloat_complex_float_div(struct kefir_softfloat_complex_float,
                                                                       struct kefir_softfloat_complex_float);
struct kefir_softfloat_complex_double kefir_softfloat_complex_double_div(struct kefir_softfloat_complex_double,
                                                                         struct kefir_softfloat_complex_double);
