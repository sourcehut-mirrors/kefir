...
kefir_result_t kefir_graph_add_edge(struct kefir_mem *, struct kefir_graph *, kefir_graph_vertex_id_t,
                                    kefir_graph_vertex_id_t);
...
kefir_result_t kefir_graph_iter(const struct kefir_graph *, struct kefir_graph_vertex_iterator *,
                                kefir_graph_vertex_id_t *);
...
kefir_result_t kefir_graph_edge_iter(const struct kefir_graph *, struct kefir_graph_edge_iterator *,
                                     kefir_graph_vertex_id_t, kefir_graph_vertex_id_t *);
