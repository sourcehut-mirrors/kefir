...
kefir_size_t kefir_opt_code_container_block_count(const struct kefir_opt_code_container *);
...
kefir_result_t kefir_opt_move_instruction(struct kefir_opt_code_container *, kefir_opt_instruction_ref_t,
                                          kefir_opt_block_id_t);
kefir_result_t kefir_opt_code_container_drop_instr(struct kefir_mem *, struct kefir_opt_code_container *,
                                                   kefir_opt_instruction_ref_t);
...
kefir_result_t kefir_opt_code_container_replace_references_in(struct kefir_mem *,
...
kefir_result_t kefir_opt_code_container_phi_attach(struct kefir_mem *, struct kefir_opt_code_container *,
                                                   ...
                                                   kefir_opt_instruction_ref_t);
kefir_result_t kefir_opt_code_container_phi_replace(struct kefir_mem *, struct kefir_opt_code_container *,
                                                    kefir_opt_instruction_ref_t, kefir_opt_block_id_t,
                                                    kefir_opt_instruction_ref_t);
kefir_result_t kefir_opt_code_container_phi_link_for(const struct kefir_opt_code_container *,
                                                     kefir_opt_instruction_ref_t, kefir_opt_block_id_t,
                                                     kefir_opt_instruction_ref_t *);
...
kefir_result_t kefir_opt_code_container_call_set_argument(struct kefir_mem *, struct kefir_opt_code_container *,
                                                          ...
                                                          kefir_opt_instruction_ref_t);
kefir_result_t kefir_opt_code_container_call_get_argument(const struct kefir_opt_code_container *,
                                                          kefir_opt_instruction_ref_t, kefir_size_t,
                                                          kefir_opt_instruction_ref_t *);
...
kefir_result_t kefir_opt_code_block_instr_head(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                               kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_instr_tail(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                               kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_instr_control_head(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                                       kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_instr_control_tail(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                                       kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_phi_head(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                             kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_phi_tail(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                             kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_call_head(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                              kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_call_tail(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                              kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_inline_assembly_head(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                                         kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_code_block_inline_assembly_tail(const struct kefir_opt_code_container *, kefir_opt_block_id_t,
                                                         kefir_opt_instruction_ref_t *);
...
kefir_result_t kefir_opt_instruction_next_control(const struct kefir_opt_code_container *, kefir_opt_instruction_ref_t,
                                                  kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_phi_prev_sibling(const struct kefir_opt_code_container *, kefir_opt_instruction_ref_t,
                                          kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_phi_next_sibling(const struct kefir_opt_code_container *, kefir_opt_instruction_ref_t,
                                          kefir_opt_instruction_ref_t *);
kefir_result_t kefir_opt_call_prev_sibling(const struct kefir_opt_code_container *, kefir_opt_instruction_ref_t,
                                           kefir_opt_instruction_ref_t *);
...
kefir_result_t kefir_opt_phi_node_link_iter(const struct kefir_opt_code_container *, kefir_opt_instruction_ref_t,
