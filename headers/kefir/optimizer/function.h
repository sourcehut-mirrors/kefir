...
typedef struct kefir_opt_function_declaration {
    const struct kefir_ir_function_decl *ir_func_decl;
    const struct kefir_opt_type_descriptor *parameters_type;
    const struct kefir_opt_type_descriptor *result_type;
} kefir_opt_function_declaration_t;

typedef struct kefir_opt_function {
    const struct kefir_ir_function *ir_func;
    const struct kefir_opt_function_declaration *declaration;
    const struct kefir_opt_type_descriptor *locals_type;
    struct kefir_opt_code_container code;
} kefir_opt_function_t;

kefir_result_t kefir_opt_function_declaration_init(const struct kefir_opt_module *,
                                                   const struct kefir_ir_function_decl *,
                                                   struct kefir_opt_function_declaration *);
