...
kefir_result_t kefir_opt_code_format(struct kefir_mem *, struct kefir_json_output *,
                                     const struct kefir_opt_code_container *, const struct kefir_opt_code_analysis *,
