...
kefir_result_t kefir_opt_code_instruction_linear_liveness_iter(
    const struct kefir_opt_code_linear_liveness *, kefir_opt_instruction_ref_t,
    struct kefir_opt_code_instruction_linear_liveness_iterator *, kefir_opt_block_id_t *, kefir_uint32_t *,
    kefir_uint32_t *);
