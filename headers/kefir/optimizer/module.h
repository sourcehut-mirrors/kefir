...
kefir_result_t kefir_opt_module_construct(struct kefir_mem *, const struct kefir_ir_target_platform *,
                                          struct kefir_opt_module *, kefir_bool_t, kefir_bool_t);
...
kefir_result_t kefir_opt_module_require_runtime_function(struct kefir_mem *, struct kefir_opt_module *, const char *);
