...
typedef enum kefir_keyword_token {
    ...
    KEFIR_KEYWORD_DECIMAL32,
    KEFIR_KEYWORD_DECIMAL64,
    KEFIR_KEYWORD_DECIMAL128,
    KEFIR_KEYWORD_FLOAT32,
    KEFIR_KEYWORD_FLOAT64,
    KEFIR_KEYWORD_FLOAT80,
    KEFIR_KEYWORD_FLOAT32X,
    KEFIR_KEYWORD_FLOAT64X,
    KEFIR_KEYWORD_DECIMAL64X,
    KEFIR_KEYWORD_INT128,
...
typedef enum kefir_constant_token_type {
    ...
    KEFIR_CONSTANT_TOKEN_FLOAT32,
    KEFIR_CONSTANT_TOKEN_FLOAT32X,
    KEFIR_CONSTANT_TOKEN_DOUBLE,
    KEFIR_CONSTANT_TOKEN_FLOAT64,
    KEFIR_CONSTANT_TOKEN_FLOAT64X,
    KEFIR_CONSTANT_TOKEN_LONG_DOUBLE,
    KEFIR_CONSTANT_TOKEN_FLOAT80,
    ...
    KEFIR_CONSTANT_TOKEN_DECIMAL64X,
...
kefir_result_t kefir_token_new_pp_header_name(struct kefir_mem *, kefir_bool_t, const char *, kefir_size_t,
                                              struct kefir_token *);
kefir_result_t kefir_token_new_extension(struct kefir_mem *, const struct kefir_token_extension_class *, void *,
                                         struct kefir_token *);
...
typedef struct kefir_token_cursor_handle {
    ...
    kefir_result_t (*flush)(const struct kefir_token_cursor_handle *, kefir_size_t);
