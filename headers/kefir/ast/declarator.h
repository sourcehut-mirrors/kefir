...
struct kefir_ast_declarator *kefir_ast_declarator_identifier(struct kefir_mem *, struct kefir_memory_arena *, struct kefir_string_pool *,
                                                             const char *);
struct kefir_ast_declarator *kefir_ast_declarator_pointer(struct kefir_mem *, struct kefir_memory_arena *, struct kefir_ast_declarator *);
