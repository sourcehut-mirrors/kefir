...
kefir_result_t kefir_ast_context_update_existing_scoped_type_tag(struct kefir_mem *, struct kefir_ast_type_bundle *,
...
struct kefir_ast_scoped_identifier *kefir_ast_context_allocate_scoped_label(
    struct kefir_mem *, struct kefir_ast_flow_control_tree *flow_control_tree,
