...
typedef enum kefir_ast_type_tag {
    ...
    KEFIR_AST_TYPE_SCALAR_UNSIGNED_INT128,
    KEFIR_AST_TYPE_SCALAR_SIGNED_INT128,
    KEFIR_AST_TYPE_SCALAR_SIGNED_BIT_PRECISE,
    KEFIR_AST_TYPE_SCALAR_UNSIGNED_BIT_PRECISE,
    KEFIR_AST_TYPE_SCALAR_FLOAT,
    KEFIR_AST_TYPE_SCALAR_DOUBLE,
    KEFIR_AST_TYPE_SCALAR_LONG_DOUBLE,
    KEFIR_AST_TYPE_SCALAR_INTERCHANGE_FLOAT32,
    KEFIR_AST_TYPE_SCALAR_INTERCHANGE_FLOAT64,
    KEFIR_AST_TYPE_SCALAR_INTERCHANGE_FLOAT80,
    KEFIR_AST_TYPE_SCALAR_EXTENDED_FLOAT32,
    KEFIR_AST_TYPE_SCALAR_EXTENDED_FLOAT64,
    KEFIR_AST_TYPE_SCALAR_POINTER,
    KEFIR_AST_TYPE_SCALAR_NULL_POINTER,
    KEFIR_AST_TYPE_SCALAR_DECIMAL32,
    KEFIR_AST_TYPE_SCALAR_DECIMAL64,
    KEFIR_AST_TYPE_SCALAR_DECIMAL128,
    KEFIR_AST_TYPE_SCALAR_EXTENDED_DECIMAL64,
    KEFIR_AST_TYPE_COMPLEX_FLOATING_POINT,
    KEFIR_AST_TYPE_IMAGINARY_FLOATING_POINT,
