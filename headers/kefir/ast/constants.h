...
typedef enum kefir_ast_constant_type {
    ...
    KEFIR_AST_FLOAT32X_CONSTANT,
    KEFIR_AST_DOUBLE_CONSTANT,
    KEFIR_AST_FLOAT64_CONSTANT,
    KEFIR_AST_FLOAT64X_CONSTANT,
    KEFIR_AST_LONG_DOUBLE_CONSTANT,
    KEFIR_AST_FLOAT80_CONSTANT,
    KEFIR_AST_DECIMAL32_CONSTANT,
    KEFIR_AST_DECIMAL64_CONSTANT,
    KEFIR_AST_DECIMAL128_CONSTANT,
    KEFIR_AST_DECIMAL64X_CONSTANT,
    KEFIR_AST_COMPLEX_FLOAT_CONSTANT,
    KEFIR_AST_COMPLEX_DOUBLE_CONSTANT,
    KEFIR_AST_COMPLEX_LONG_DOUBLE_CONSTANT,
    KEFIR_AST_COMPLEX_FLOAT32_CONSTANT,
    KEFIR_AST_COMPLEX_FLOAT32X_CONSTANT,
    KEFIR_AST_COMPLEX_FLOAT64_CONSTANT,
    KEFIR_AST_COMPLEX_FLOAT64X_CONSTANT,
...
typedef enum kefir_ast_type_specifier_type {
    ...
    KEFIR_AST_TYPE_SPECIFIER_IMAGINARY,
    ...
    KEFIR_AST_TYPE_SPECIFIER_DECIMAL32,
    KEFIR_AST_TYPE_SPECIFIER_DECIMAL64,
    KEFIR_AST_TYPE_SPECIFIER_DECIMAL128,
    KEFIR_AST_TYPE_SPECIFIER_FLOAT32,
    KEFIR_AST_TYPE_SPECIFIER_FLOAT64,
    ...
    KEFIR_AST_TYPE_SPECIFIER_INT128,
    // Special value
...
typedef enum kefir_ast_builtin_operator {
    ...
    KEFIR_AST_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_FLOAT,
    KEFIR_AST_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_DOUBLE,
    KEFIR_AST_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_LONG_DOUBLE,
    KEFIR_AST_BUILTIN_KEFIR_ISFINITE,
    KEFIR_AST_BUILTIN_KEFIR_INFD32,
