...
kefir_result_t kefir_ir_format_instr_u64(struct kefir_json_output *, const struct kefir_ir_module *,
                                         const struct kefir_irinstr *);
kefir_result_t kefir_ir_format_instr_boolean(struct kefir_json_output *, const struct kefir_ir_module *,
                                             const struct kefir_irinstr *);
...
kefir_result_t kefir_ir_format_instr_memflags(struct kefir_json_output *, const struct kefir_ir_module *,
                                              const struct kefir_irinstr *);
kefir_result_t kefir_ir_format_instr_bitint_load_memflags(struct kefir_json_output *, const struct kefir_ir_module *,
                                                          const struct kefir_irinstr *);
kefir_result_t kefir_ir_format_instr_bitint_store_memflags(struct kefir_json_output *, const struct kefir_ir_module *,
                                                           const struct kefir_irinstr *);
kefir_result_t kefir_ir_format_instr_bitint_atomic_load_memflags(struct kefir_json_output *,
                                                                 const struct kefir_ir_module *,
                                                                 const struct kefir_irinstr *);
kefir_result_t kefir_ir_format_instr_bitint_atomic_store_memflags(struct kefir_json_output *,
                                                                  const struct kefir_ir_module *,
                                                                  const struct kefir_irinstr *);
...
kefir_result_t kefir_ir_format_instr_localvar(struct kefir_json_output *, const struct kefir_ir_module *,
                                              const struct kefir_irinstr *);
kefir_result_t kefir_ir_format_instr_tmpobj(struct kefir_json_output *, const struct kefir_ir_module *,
                                            const struct kefir_irinstr *);
