...
#define KEFIR_IR_OPCODE_DEFS(OPCODE, SEPARATOR) \
    ...
    OPCODE(UMUL8,       "umul8",        none) SEPARATOR \
    OPCODE(UMUL16,      "umul16",       none) SEPARATOR \
    OPCODE(UMUL32,      "umul32",       none) SEPARATOR \
    OPCODE(UMUL64,      "umul64",       none) SEPARATOR \
    ...
    /* Logics & coditions */ \
    OPCODE(IEQUALS8,     "iequals8",      none) SEPARATOR \
    OPCODE(IGREATER8,    "igreater8",     none) SEPARATOR \
