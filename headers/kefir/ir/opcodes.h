...
typedef enum kefir_iropcode {
    ...
    KEFIR_IROPCODE_LOADLD = 0x5b,
    KEFIR_IROPCODE_STORE8 = 0x5c,
    KEFIR_IROPCODE_STORE16 = 0x5d,
    KEFIR_IROPCODE_STORE32 = 0x5e,
    KEFIR_IROPCODE_STORE64 = 0x5f,
    KEFIR_IROPCODE_STORELD = 0x60,
    KEFIR_IROPCODE_BZERO = 0x61,
    KEFIR_IROPCODE_BCOPY = 0x62,
    KEFIR_IROPCODE_EXTUBITS = 0x63,
    KEFIR_IROPCODE_EXTSBITS = 0x64,
    KEFIR_IROPCODE_INSERTBITS = 0x65,
    KEFIR_IROPCODE_GETTHRLOCAL = 0x66,
    ...
    KEFIR_IROPCODE_SETLDH = 0x92,
    KEFIR_IROPCODE_SETLDL = 0x93,
