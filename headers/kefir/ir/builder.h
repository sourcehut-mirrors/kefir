...
kefir_result_t kefir_irbuilder_block_appendu64(struct kefir_mem *, struct kefir_irblock *, kefir_iropcode_t,
                                               kefir_uint64_t);
kefir_result_t kefir_irbuilder_block_appendu64_2(struct kefir_mem *, struct kefir_irblock *, kefir_iropcode_t,
...
typedef struct kefir_irbuilder_block {
    ...
    kefir_result_t (*appendu64_2)(struct kefir_irbuilder_block *, kefir_iropcode_t, kefir_uint64_t, kefir_uint64_t);
...
#define KEFIR_IRBUILDER_BLOCK_APPENDU64_2(builder, opcode, arg, arg2) \
    ((builder)->appendu64_2((builder), (opcode), (arg), (arg2)))
