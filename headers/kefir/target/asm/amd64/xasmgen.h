...
typedef enum kefir_asm_amd64_xasmgen_register {
    ...
    KEFIR_AMD64_XASMGEN_REGISTER_AH,
    KEFIR_AMD64_XASMGEN_REGISTER_BL,
    KEFIR_AMD64_XASMGEN_REGISTER_BH,
    KEFIR_AMD64_XASMGEN_REGISTER_CL,
    KEFIR_AMD64_XASMGEN_REGISTER_CH,
    KEFIR_AMD64_XASMGEN_REGISTER_DL,
    KEFIR_AMD64_XASMGEN_REGISTER_DH,
...
typedef enum kefir_asm_amd64_xasmgen_symbol_relocation {
    KEFIR_AMD64_XASMGEN_SYMBOL_ABSOLUTE,
    KEFIR_AMD64_XASMGEN_SYMBOL_RELATIVE_PLT,
    KEFIR_AMD64_XASMGEN_SYMBOL_RELATIVE_GOTPCREL,
    KEFIR_AMD64_XASMGEN_SYMBOL_RELATIVE_TPOFF,
    KEFIR_AMD64_XASMGEN_SYMBOL_RELATIVE_DTPOFF,
    KEFIR_AMD64_XASMGEN_SYMBOL_RELATIVE_GOTTPOFF,
...
typedef struct kefir_asm_amd64_xasmgen_operand {
    ...
    union {
        ...
        struct {
            kefir_asm_amd64_xasmgen_symbol_relocation_t type;
            const char *symbol;
        } label;
        struct {
...
const struct kefir_asm_amd64_xasmgen_operand *kefir_asm_amd64_xasmgen_operand_indirect(
    ...
    struct kefir_asm_amd64_xasmgen_indirection_index, kefir_int64_t);
...
#define KEFIR_AMD64_XASMGEN_INSTR_FSUB(_xasmgen, _op1) ((_xasmgen)->instr.fsub((_xasmgen), (_op1)))
#define KEFIR_AMD64_XASMGEN_INSTR_FSUBP(_xasmgen) ((_xasmgen)->instr.fsubp((_xasmgen)))
#define KEFIR_AMD64_XASMGEN_INSTR_FMUL(_xasmgen, _op1) ((_xasmgen)->instr.fmul((_xasmgen), (_op1)))
#define KEFIR_AMD64_XASMGEN_INSTR_FMULP(_xasmgen) ((_xasmgen)->instr.fmulp((_xasmgen)))
#define KEFIR_AMD64_XASMGEN_INSTR_FDIV(_xasmgen, _op1) ((_xasmgen)->instr.fdiv((_xasmgen), (_op1)))
