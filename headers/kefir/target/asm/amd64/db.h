...
#define KEFIR_AMD64_INSTRUCTION_DATABASE(_instr0, _instr1, _instr2, _instr3, _separator) \
    ...
    _instr2(movd, "movd", , KEFIR_AMD64_INSTRDB_BOTH_MEMORY, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY_SINGLE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY_SINGLE) _separator \
    _instr2(movq, "movq", , KEFIR_AMD64_INSTRDB_BOTH_MEMORY, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY_DOUBLE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY_DOUBLE) _separator \
