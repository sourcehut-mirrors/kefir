...
#define KEFIR_AMD64_INSTRDB_PREFIX_INSTRUCTION KEFIR_AMD64_INSTRDB_FLAG(3)
#define KEFIR_AMD64_INSTRDB_ACCESS_X87_ENVIRONMENT KEFIR_AMD64_INSTRDB_FLAG(4)
#define KEFIR_AMD64_INSTRDB_MODIFY_X87_ENVIRONMENT KEFIR_AMD64_INSTRDB_FLAG(5)
#define KEFIR_AMD64_INSTRDB_ACCESS_MXCSR KEFIR_AMD64_INSTRDB_FLAG(6)
#define KEFIR_AMD64_INSTRDB_MODIFY_MXCSR KEFIR_AMD64_INSTRDB_FLAG(7)
#define KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS KEFIR_AMD64_INSTRDB_FLAG(8)
...
#define KEFIR_AMD64_INSTRDB_JCC_INSTRUCTION KEFIR_AMD64_INSTRDB_CONTROL_FLOW_JUMP_FALLTHROUGH
...
#define KEFIR_AMD64_INSTRUCTION_DATABASE(_instr0, _instr1, _instr2, _instr3, _separator) \
    ...
    _instr2(cmovl, "cmovl", , KEFIR_AMD64_INSTRDB_NONE, \
        ...
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovle, "cmovle", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovg, "cmovg", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovge, "cmovge", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmove, "cmove", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovbe, "cmovbe", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovb, "cmovb", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmova, "cmova", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovae, "cmovae", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovne, "cmovne", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovs, "cmovs", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovns, "cmovns", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovz, "cmovz", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(cmovnz, "cmovnz", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    ...
    _instr2(cmp, "cmp", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr2(cmpxchg, "cmpxchg", , KEFIR_AMD64_INSTRDB_NONE | KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER) _separator \
    ...
    _instr1(setb, "setb", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_SETCC_TARGET) _separator \
    _instr1(setnb, "setnb", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_SETCC_TARGET) _separator \
    ...
    _instr2(add, "add", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr2(xadd, "xadd", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER) _separator \
    _instr2(adc, "adc", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr2(sub, "sub", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr2(sbb, "sbb", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr1(mul, "mul", , KEFIR_AMD64_INSTRDB_NONE | KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr1(imul1, "imul", , KEFIR_AMD64_INSTRDB_NONE | KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    ...
    _instr1(idiv, "idiv", , KEFIR_AMD64_INSTRDB_NONE | KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr1(div, "div", , KEFIR_AMD64_INSTRDB_NONE | KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    ...
    _instr3(shld, "shld", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
    ...
    _instr2(shr, "shr", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER8 | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr3(shrd, "shrd", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER8 | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    ...
    _instr1(neg, "neg", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr1(dec, "dec", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(bsf, "bsf", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(bsf2, "bsf", REPEATABLE, KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(bsr, "bsr", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    _instr2(rol, "rol", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER | KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    ...
    _instr2(fcmove, "fcmove", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_FPU_STACK, KEFIR_AMD64_INSTRDB_FPU_STACK) _separator \
    /* fenv */ \
