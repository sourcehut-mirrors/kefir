...
#define KEFIR_AMD64_INSTRUCTION_DATABASE(_instr0, _instr1, _instr2, _instr3, _separator) \
    ...
    _instr0(movsb, "movsb", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(movsw, "movsw", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(movsl, "movsl", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(movsq, "movsq", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(stosb, "stosb", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(stosw, "stosw", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(stosl, "stosl", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    _instr0(stosq, "stosq", REPEATABLE, KEFIR_AMD64_INSTRDB_IMPLICIT_PARAMS) _separator \
    /* Flags */ \
