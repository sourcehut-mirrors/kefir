...
// SSE operand flags
#define KEFIR_AMD64_INSTRDB_XMM_REGISTER KEFIR_AMD64_INSTRDB_FLAG(12)
// Memory operand flags
#define KEFIR_AMD64_INSTRDB_MEMORY8 KEFIR_AMD64_INSTRDB_FLAG(16)
#define KEFIR_AMD64_INSTRDB_MEMORY16 KEFIR_AMD64_INSTRDB_FLAG(17)
#define KEFIR_AMD64_INSTRDB_MEMORY32 KEFIR_AMD64_INSTRDB_FLAG(18)
#define KEFIR_AMD64_INSTRDB_MEMORY64 KEFIR_AMD64_INSTRDB_FLAG(19)
#define KEFIR_AMD64_INSTRDB_MEMORY80 KEFIR_AMD64_INSTRDB_FLAG(20)
#define KEFIR_AMD64_INSTRDB_MEMORY128 KEFIR_AMD64_INSTRDB_FLAG(21)
#define KEFIR_AMD64_INSTRDB_MEMORY_FP_SINGLE KEFIR_AMD64_INSTRDB_FLAG(22)
#define KEFIR_AMD64_INSTRDB_MEMORY_FP_DOUBLE KEFIR_AMD64_INSTRDB_FLAG(23)
// Other operands
#define KEFIR_AMD64_INSTRDB_X87 KEFIR_AMD64_INSTRDB_FLAG(24)
#define KEFIR_AMD64_INSTRDB_LABEL KEFIR_AMD64_INSTRDB_FLAG(25)
#define KEFIR_AMD64_INSTRDB_IMMEDIATE KEFIR_AMD64_INSTRDB_FLAG(26)
// Instruction flags
#define KEFIR_AMD64_INSTRDB_BOTH_MEMORY KEFIR_AMD64_INSTRDB_FLAG(32)

// Flag combinations
#define KEFIR_AMD64_INSTRDB_READ_WRITE (KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_READ_WRITE)
...
#define KEFIR_AMD64_INSTRDB_GP_REGISTER32_64 (KEFIR_AMD64_INSTRDB_GP_REGISTER32 | KEFIR_AMD64_INSTRDB_GP_REGISTER64)
#define KEFIR_AMD64_INSTRDB_MEMORY                                                               \
    (KEFIR_AMD64_INSTRDB_MEMORY8 | KEFIR_AMD64_INSTRDB_MEMORY16 | KEFIR_AMD64_INSTRDB_MEMORY32 | \
     KEFIR_AMD64_INSTRDB_MEMORY64)
#define KEFIR_AMD64_INSTRDB_MEMORY32_64 (KEFIR_AMD64_INSTRDB_MEMORY32 | KEFIR_AMD64_INSTRDB_MEMORY64)
#define KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY (KEFIR_AMD64_INSTRDB_GP_REGISTER | KEFIR_AMD64_INSTRDB_MEMORY)
#define KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY32_64 \
    (KEFIR_AMD64_INSTRDB_GP_REGISTER32_64 | KEFIR_AMD64_INSTRDB_MEMORY32_64)
#define KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY32 (KEFIR_AMD64_INSTRDB_XMM_REGISTER | KEFIR_AMD64_INSTRDB_MEMORY32)
#define KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY64 (KEFIR_AMD64_INSTRDB_XMM_REGISTER | KEFIR_AMD64_INSTRDB_MEMORY64)
#define KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY128 (KEFIR_AMD64_INSTRDB_XMM_REGISTER | KEFIR_AMD64_INSTRDB_MEMORY128)
#define KEFIR_AMD64_INSTRDB_MEMORYFP (KEFIR_AMD64_INSTRDB_MEMORY_FP_SINGLE | KEFIR_AMD64_INSTRDB_MEMORY_FP_DOUBLE)
#define KEFIR_AMD64_INSTRDB_X87_REGISTER_MEMORYFP (KEFIR_AMD64_INSTRDB_X87 | KEFIR_AMD64_INSTRDB_MEMORYFP)
...
#define KEFIR_AMD64_INSTRUCTION_DATABASE(_instr0, _instr1, _instr2, _instr3, _separator) \
    ...
    _instr1(call, "call", BRANCH, KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER64 | KEFIR_AMD64_INSTRDB_MEMORY64 | KEFIR_AMD64_INSTRDB_LABEL) _separator \
    ...
    _instr2(lea, "lea", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER, \
        KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    ...
    _instr1(neg, "neg", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY) _separator \
    /* SSE */ \
    _instr2(movd, "movd", , KEFIR_AMD64_INSTRDB_BOTH_MEMORY, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER) _separator \
    _instr2(movq, "movq", , KEFIR_AMD64_INSTRDB_BOTH_MEMORY, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY | KEFIR_AMD64_INSTRDB_XMM_REGISTER) _separator \
    _instr2(movdqu, "movdqu", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY128, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY128) _separator \
    _instr2(cvtsi2ss, "cvtsi2ss", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY32_64) _separator \
    _instr2(cvtsi2sd, "cvtsi2sd", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY32_64) _separator \
    _instr2(cvttss2si, "cvttss2si", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER32_64, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY32) _separator \
    _instr2(cvttsd2si, "cvttsd2si", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER32_64, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY64) _separator \
    ...
    _instr2(pxor, "pxor", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ_WRITE | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY128) _separator \
    ...
    _instr2(ucomiss, "ucomiss", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY32) _separator \
    ...
    _instr1(stmxcsr, "stmxcsr", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY32) _separator \
    _instr1(ldmxcsr, "ldmxcsr", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER_MEMORY32) _separator \
    _instr3(pextrq, "pextrq", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_GP_REGISTER64 | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY64, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    _instr3(pinsrq, "pinsrq", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_XMM_REGISTER, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_GP_REGISTER64 | KEFIR_AMD64_INSTRDB_GP_REGISTER_MEMORY64, \
        KEFIR_AMD64_INSTRDB_IMMEDIATE) _separator \
    /* x87 */ \
    _instr1(fld, "fld", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_X87_REGISTER_MEMORYFP) _separator \
    ...
    _instr1(fstp, "fstp", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_WRITE | KEFIR_AMD64_INSTRDB_X87_REGISTER_MEMORYFP) _separator \
    _instr1(fadd, "fadd", , KEFIR_AMD64_INSTRDB_NONE, \
        KEFIR_AMD64_INSTRDB_READ | KEFIR_AMD64_INSTRDB_MEMORYFP) _separator \
