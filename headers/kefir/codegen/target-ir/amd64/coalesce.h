...
kefir_result_t kefir_codegen_target_ir_amd64_coalesce_init(struct kefir_codegen_target_ir_amd64_coalesce_class *, const struct kefir_codegen_target_ir_round_trip_destructor_ops *);
