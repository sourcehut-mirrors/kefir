...
kefir_result_t kefir_codegen_target_ir_amd64_match_immediate(const struct kefir_codegen_target_ir_code *,
                                                             kefir_codegen_target_ir_value_ref_t, kefir_bool_t,
                                                             kefir_int64_t *);
kefir_result_t kefir_codegen_target_ir_amd64_match_immediate_operand(const struct kefir_codegen_target_ir_code *,
