...
kefir_result_t kefir_codegen_target_ir_amd64_peephole_neg(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                          const struct kefir_codegen_target_ir_instruction *,
                                                          kefir_bool_t *);
kefir_result_t kefir_codegen_target_ir_amd64_peephole_not(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                          const struct kefir_codegen_target_ir_instruction *,
                                                          kefir_bool_t *);
...
kefir_result_t kefir_codegen_target_ir_amd64_peephole_mov(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                          const struct kefir_codegen_target_ir_instruction *,
                                                          kefir_bool_t *);
kefir_result_t kefir_codegen_target_ir_amd64_peephole_movabs(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                             const struct kefir_codegen_target_ir_instruction *,
                                                             kefir_bool_t *);
...
kefir_result_t kefir_codegen_target_ir_amd64_peephole_fxch(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                           const struct kefir_codegen_target_ir_instruction *,
                                                           kefir_bool_t *);
kefir_result_t kefir_codegen_target_ir_amd64_peephole_jmp(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                          const struct kefir_codegen_target_ir_instruction *,
                                                          kefir_bool_t *);
kefir_result_t kefir_codegen_target_ir_amd64_peephole_jcc(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                          const struct kefir_codegen_target_ir_instruction *,
                                                          kefir_bool_t *);
...
kefir_result_t kefir_codegen_target_ir_amd64_peephole_rmw_mem(struct kefir_mem *, struct kefir_codegen_target_ir_code *,
                                                              const struct kefir_codegen_target_ir_instruction *,
                                                              kefir_bool_t *);
