...
kefir_result_t kefir_codegen_target_ir_amd64_transform_late_jump_propagation(
    struct kefir_mem *, struct kefir_codegen_target_ir_code *, const struct kefir_codegen_target_ir_regalloc *);
kefir_result_t kefir_codegen_target_ir_amd64_transform_late_split_epilogue(struct kefir_mem *,
