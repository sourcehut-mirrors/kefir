...
kefir_result_t kefir_codegen_target_ir_round_trip_destruct(struct kefir_mem *, const struct kefir_codegen_target_ir_code *, struct kefir_asmcmp_context *, const struct kefir_codegen_target_ir_round_trip_destructor_ops *);
