...
typedef struct kefir_codegen_target_ir_regalloc_state {
    ...
    kefir_result_t (*add_allocation_hint)(struct kefir_mem *, kefir_codegen_target_ir_regalloc_allocation_t,
                                          kefir_uint32_t, void *);
...
typedef struct kefir_codegen_target_ir_regalloc_transforms {
    ...
    kefir_uint32_t rematerialization_locality;
...
typedef struct kefir_codegen_target_ir_regalloc_class {
    ...
    kefir_result_t (*do_allocate)(struct kefir_mem *, const struct kefir_codegen_target_ir_value_type *,
                                  ...
                                  kefir_bool_t, kefir_codegen_target_ir_regalloc_allocation_t *, kefir_uint32_t *,
                                  void *);
