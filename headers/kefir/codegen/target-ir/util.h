...
kefir_result_t kefir_codegen_target_ir_match_immediate_assignment(const struct kefir_codegen_target_ir_code *, kefir_codegen_target_ir_value_ref_t, kefir_uint64_t *);
