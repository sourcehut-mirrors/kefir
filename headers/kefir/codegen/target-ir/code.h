...
#define KEFIR_CODEGEN_TARGET_IR_OPERATION_NUM_OF_PARAMETERS 7
...
typedef kefir_uint16_t kefir_codegen_target_ir_resource_id_t;
...
typedef enum kefir_codegen_target_ir_value_aspect {
    ...
    KEFIR_CODEGEN_TARGET_IR_VALUE_ASPECT_RESOURCE,
...
typedef enum kefir_codegen_target_ir_value_type_kind {
    ...
    KEFIR_CODEGEN_TARGET_IR_VALUE_TYPE_RESOURCE,
...
kefir_result_t kefir_codegen_target_ir_code_replace_operation(struct kefir_mem *, struct kefir_codegen_target_ir_code *, kefir_codegen_target_ir_instruction_ref_t, const struct kefir_codegen_target_ir_operation *);
