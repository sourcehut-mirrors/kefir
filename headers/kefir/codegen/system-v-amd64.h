...
#ifndef KEFIR_CODEGEN_SYSTEM_V_AMD64_H_
#define KEFIR_CODEGEN_SYSTEM_V_AMD64_H_
...
kefir_result_t kefir_codegen_sysv_amd64_init(struct kefir_mem *, struct kefir_codegen_amd64 *, FILE *,
                                             const struct kefir_codegen_configuration *);

extern const char KefirSysVAmd64RuntimeCode[];
