...
#define DEF_OPCODE2(_opcode, _mnemonic, _variant, _flags, _op1, _op2) \
    DEF_OPCODE2_##_variant(_opcode, _mnemonic, _variant, _flags, _op1, _op2)
...
kefir_result_t kefir_asmcmp_amd64_function_prologue(struct kefir_mem *, struct kefir_asmcmp_amd64 *,
                                                    kefir_asmcmp_instruction_index_t,
                                                    kefir_asmcmp_instruction_index_t *);
kefir_result_t kefir_asmcmp_amd64_function_epilogue(struct kefir_mem *, struct kefir_asmcmp_amd64 *, kefir_bool_t,
                                                    kefir_asmcmp_instruction_index_t,
                                                    kefir_asmcmp_instruction_index_t *);

kefir_result_t kefir_asmcmp_amd64_tail_call(struct kefir_mem *, struct kefir_asmcmp_amd64 *,
                                            kefir_asmcmp_instruction_index_t, const struct kefir_asmcmp_value *,
                                            kefir_asmcmp_instruction_index_t *);
