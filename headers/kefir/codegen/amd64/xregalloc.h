...
typedef enum kefir_codegen_amd64_register_allocation_type {
    ...
    KEFIR_CODEGEN_AMD64_VIRTUAL_REGISTER_ALLOCATION_LOCAL_VARIABLE,
    KEFIR_CODEGEN_AMD64_VIRTUAL_REGISTER_ALLOCATION_PAIR,
    KEFIR_CODEGEN_AMD64_VIRTUAL_REGISTER_ALLOCATION_IMMEDIATE_INTEGER,
