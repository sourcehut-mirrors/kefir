...
typedef struct kefir_codegen_amd64_dwarf_abbrev_context {
    struct {
        ...
        kefir_codegen_amd64_dwarf_entry_id_t label;
...
typedef struct kefir_codegen_amd64_dwarf_strings_context {
    struct {
        kefir_codegen_amd64_dwarf_entry_id_t next_string_id;
        struct kefir_hashtree strings;
    } entries;
} kefir_codegen_amd64_dwarf_strings_context_t;
...
typedef struct kefir_codegen_amd64_dwarf_context {
    ...
    struct kefir_codegen_amd64_dwarf_strings_context strings;
...
kefir_result_t kefir_codegen_amd64_dwarf_generate_global_identifiers(struct kefir_mem *, struct kefir_codegen_amd64 *,
                                                                     const struct kefir_ir_module *,
                                                                     const struct kefir_opt_module_liveness *,
                                                                     struct kefir_codegen_amd64_dwarf_context *);
...
kefir_result_t kefir_codegen_amd64_dwarf_generate_lexical_block(
    struct kefir_mem *, struct kefir_codegen_amd64_function *, struct kefir_codegen_amd64_dwarf_context *,
    const struct kefir_opt_module_liveness *, kefir_ir_debug_entry_id_t, kefir_codegen_amd64_dwarf_entry_id_t *);
...
kefir_result_t kefir_codegen_amd64_dwarf_generate_instruction_location(struct kefir_mem *,
                                                                       struct kefir_codegen_amd64_function *,
                                                                       kefir_opt_instruction_ref_t);
kefir_result_t kefir_codegen_amd64_dwarf_generate_label(struct kefir_mem *, struct kefir_codegen_amd64_function *,
                                                        struct kefir_codegen_amd64_dwarf_context *,
                                                        kefir_ir_debug_entry_id_t,
                                                        kefir_codegen_amd64_dwarf_entry_id_t *);

kefir_result_t kefir_codegen_amd64_dwarf_collect_code_fragments(struct kefir_mem *,
                                                                struct kefir_codegen_amd64_function *,
                                                                kefir_opt_code_debug_info_code_ref_t,
                                                                kefir_opt_code_debug_info_code_ref_t,
                                                                struct kefir_hashtree *);
kefir_result_t kefir_codegen_amd64_dwarf_generate_range_list_coalesce(struct kefir_mem *,
                                                                      struct kefir_codegen_amd64_function *,
                                                                      kefir_opt_code_debug_info_code_ref_t,
                                                                      kefir_opt_code_debug_info_code_ref_t,
                                                                      struct kefir_hashtree *);
