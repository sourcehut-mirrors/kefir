...
kefir_result_t kefir_codegen_amd64_stack_frame_allocate_local(struct kefir_mem *,
                                                              struct kefir_codegen_amd64_stack_frame *, kefir_size_t,
                                                              kefir_size_t, kefir_id_t *);
