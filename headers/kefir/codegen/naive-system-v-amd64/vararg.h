...
#ifndef KEFIR_CODEGEN_NAIVE_SYSTEM_V_AMD64_VARARG_H_
#define KEFIR_CODEGEN_NAIVE_SYSTEM_V_AMD64_VARARG_H_
...
kefir_result_t kefir_codegen_naive_amd64_sysv_vararg_instruction(struct kefir_mem *, struct kefir_codegen_naive_amd64 *,
