...
KEFIR_FLAGS=-I $(HEADERS) -W --codegen-syntax -Wx86_64-att
...
KEFIR_FLAGS += --target x86_64-netbsd-system -D__GNUC__=4 -D__GNUC_MINOR__=20 -D__GNUC_STDC_INLINE__=1 -include $(HEADERS)/bootstrap_include/netbsd.h
else
