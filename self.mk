...
$(BOOTSTRAP_DIR)/stage1/kefir_driver: $(BIN_DIR)/kefir_driver
	@echo "Bootstrapping $@"
...
$(BOOTSTRAP_DIR)/stage2/kefir_driver: $(BOOTSTRAP_DIR)/stage1/kefir_driver
	@echo "Bootstrapping $@"
	@$(MAKE) -f $(ROOT)/bootstrap.mk bootstrap \
		SOURCE=$(SOURCE_DIR) \
		HEADERS=$(HEADERS_DIR) \
		BOOTSTRAP=$(BOOTSTRAP_DIR)/stage2 \
		KEFIRCC=$(BOOTSTRAP_DIR)/stage1/kefir_driver \
		LIBC_HEADERS="$(LIBC_HEADERS)" \
		LIBC_LIBS="$(LIBC_LIBS)"

$(BOOTSTRAP_DIR)/stage2/comparison.done: $(BOOTSTRAP_DIR)/stage1/kefir_driver $(BOOTSTRAP_DIR)/stage2/kefir_driver
