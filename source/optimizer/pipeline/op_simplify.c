...
static kefir_result_t simplify_boot_or(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_GREATER) {
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_greater_or_equals(mem, &func->code, block_id,
                                                                arg1->operation.parameters.refs[0],
                                                                arg1->operation.parameters.refs[1], replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_GREATER_CONST) {
        REQUIRE(arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_EQUALS_CONST, KEFIR_OK);
        REQUIRE(arg1->operation.parameters.ref_imm.refs[0] == arg2->operation.parameters.ref_imm.refs[0] &&
                    arg1->operation.parameters.ref_imm.integer == arg2->operation.parameters.ref_imm.integer,
                KEFIR_OK);

        REQUIRE_OK(kefir_opt_code_builder_int_greater_or_equals_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_lesser_or_equals(mem, &func->code, block_id,
                                                               arg1->operation.parameters.refs[0],
                                                               arg1->operation.parameters.refs[1], replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_LESSER_CONST) {
        REQUIRE(arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_EQUALS_CONST, KEFIR_OK);
        REQUIRE(arg1->operation.parameters.ref_imm.refs[0] == arg2->operation.parameters.ref_imm.refs[0] &&
                    arg1->operation.parameters.ref_imm.integer == arg2->operation.parameters.ref_imm.integer,
                KEFIR_OK);

        REQUIRE_OK(kefir_opt_code_builder_int_lesser_or_equals_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_above_or_equals(mem, &func->code, block_id,
                                                              arg1->operation.parameters.refs[0],
                                                              arg1->operation.parameters.refs[1], replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_ABOVE_CONST) {
        REQUIRE(arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_EQUALS_CONST, KEFIR_OK);
        REQUIRE(arg1->operation.parameters.ref_imm.refs[0] == arg2->operation.parameters.ref_imm.refs[0] &&
                    arg1->operation.parameters.ref_imm.integer == arg2->operation.parameters.ref_imm.integer,
                KEFIR_OK);

        REQUIRE_OK(kefir_opt_code_builder_int_above_or_equals_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_below_or_equals(mem, &func->code, block_id,
                                                              arg1->operation.parameters.refs[0],
                                                              arg1->operation.parameters.refs[1], replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_BELOW_CONST) {
        REQUIRE(arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_EQUALS_CONST, KEFIR_OK);
        REQUIRE(arg1->operation.parameters.ref_imm.refs[0] == arg2->operation.parameters.ref_imm.refs[0] &&
                    arg1->operation.parameters.ref_imm.integer == arg2->operation.parameters.ref_imm.integer,
                KEFIR_OK);

        REQUIRE_OK(kefir_opt_code_builder_int_below_or_equals_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
        ...
        REQUIRE_OK(kefir_opt_code_builder_float32_greater_or_equals(
            mem, &func->code, block_id, arg1->operation.parameters.refs[0], arg1->operation.parameters.refs[1],
            replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
        ...
        REQUIRE_OK(kefir_opt_code_builder_float32_lesser_or_equals(
            ...
            replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_FLOAT64_GREATER) {
        REQUIRE(arg2->operation.opcode == KEFIR_OPT_OPCODE_FLOAT64_EQUALS, KEFIR_OK);
        REQUIRE((arg1->operation.parameters.refs[0] == arg2->operation.parameters.refs[0] &&
                 arg1->operation.parameters.refs[1] == arg2->operation.parameters.refs[1]) ||
                    (arg1->operation.parameters.refs[0] == arg2->operation.parameters.refs[1] &&
                     arg1->operation.parameters.refs[1] == arg2->operation.parameters.refs[0]),
        ...
        REQUIRE_OK(kefir_opt_code_builder_float64_greater_or_equals(
            mem, &func->code, block_id, arg1->operation.parameters.refs[0], arg1->operation.parameters.refs[1],
            replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_FLOAT64_LESSER) {
        REQUIRE(arg2->operation.opcode == KEFIR_OPT_OPCODE_FLOAT64_EQUALS, KEFIR_OK);
        REQUIRE((arg1->operation.parameters.refs[0] == arg2->operation.parameters.refs[0] &&
                 arg1->operation.parameters.refs[1] == arg2->operation.parameters.refs[1]) ||
                    (arg1->operation.parameters.refs[0] == arg2->operation.parameters.refs[1] &&
        ...
        REQUIRE_OK(kefir_opt_code_builder_float64_lesser_or_equals(
            mem, &func->code, block_id, arg1->operation.parameters.refs[0], arg1->operation.parameters.refs[1],
            replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_LONG_DOUBLE_GREATER) {
...
static kefir_result_t simplify_int_and(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST &&
        ...
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_AND_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_and_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
        ...
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
               ...
               arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_AND_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_and_const(
            mem, &func->code, block_id, arg2->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.imm.integer & arg2->operation.parameters.ref_imm.integer, replacement_ref));
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_and_const(mem, &func->code, block_id, arg1->id,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_and_const(mem, &func->code, block_id, arg2->id,
...
static kefir_result_t simplify_int_or(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_OR_CONST &&
        arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer | arg2->operation.parameters.imm.integer, replacement_ref));

        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_OR_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(
            mem, &func->code, block_id, arg2->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.imm.integer | arg2->operation.parameters.ref_imm.integer, replacement_ref));

        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_OR_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer | (kefir_int64_t) arg2->operation.parameters.imm.uinteger,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(mem, &func->code, block_id, arg1->id,
                                                       arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(mem, &func->code, block_id, arg1->id,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(mem, &func->code, block_id, arg2->id,
                                                       arg1->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_or_const(mem, &func->code, block_id, arg2->id,
...
static kefir_result_t simplify_int_xor(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_XOR_CONST &&
        arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer ^ arg2->operation.parameters.imm.integer, replacement_ref));

        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_XOR_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(
            mem, &func->code, block_id, arg2->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.imm.integer ^ arg2->operation.parameters.ref_imm.integer, replacement_ref));

        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_XOR_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer ^ (kefir_int64_t) arg2->operation.parameters.imm.uinteger,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(mem, &func->code, block_id, arg1->id,
                                                        arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(mem, &func->code, block_id, arg1->id,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(mem, &func->code, block_id, arg2->id,
                                                        arg1->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_xor_const(mem, &func->code, block_id, arg2->id,
...
static kefir_result_t simplify_int_add(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_GET_LOCAL && arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        ...
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_GET_GLOBAL && arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        ...
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_GET_THREAD_LOCAL && arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
...
static kefir_result_t simplify_int_mul(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_MUL_CONST &&
        arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer * arg2->operation.parameters.imm.integer, replacement_ref));

        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_MUL_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(
            mem, &func->code, block_id, arg2->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.imm.integer * arg2->operation.parameters.ref_imm.integer, replacement_ref));

        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_MUL_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer * (kefir_int64_t) arg2->operation.parameters.imm.uinteger,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(mem, &func->code, block_id, arg1->id,
                                                        arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(mem, &func->code, block_id, arg1->id,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(mem, &func->code, block_id, arg2->id,
                                                        arg1->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_mul_const(mem, &func->code, block_id, arg2->id,
...
static kefir_result_t simplify_int_shl(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_LSHIFT_CONST &&
        arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_lshift_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer + arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_LSHIFT_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_lshift_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer + (kefir_int64_t) arg2->operation.parameters.imm.uinteger,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_lshift_const(mem, &func->code, block_id, arg1->id,
                                                           arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_lshift_const(mem, &func->code, block_id, arg1->id,
...
static kefir_result_t simplify_int_shr(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_RSHIFT_CONST &&
        arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_rshift_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer + arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_RSHIFT_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_rshift_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer + (kefir_int64_t) arg2->operation.parameters.imm.uinteger,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_rshift_const(mem, &func->code, block_id, arg1->id,
                                                           arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_rshift_const(mem, &func->code, block_id, arg1->id,
...
static kefir_result_t simplify_int_sar(struct kefir_mem *mem, struct kefir_opt_function *func,
    ...
    if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_ARSHIFT_CONST &&
        arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_arshift_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer + arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_INT_ARSHIFT_CONST &&
               arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_arshift_const(
            mem, &func->code, block_id, arg1->operation.parameters.ref_imm.refs[0],
            arg1->operation.parameters.ref_imm.integer + (kefir_int64_t) arg2->operation.parameters.imm.uinteger,
        ...
        REQUIRE_OK(kefir_opt_code_builder_int_arshift_const(mem, &func->code, block_id, arg1->id,
                                                            arg2->operation.parameters.imm.integer, replacement_ref));
        REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref));
    } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {
        REQUIRE_OK(kefir_opt_code_builder_int_arshift_const(mem, &func->code, block_id, arg1->id,
...
#define SIMPLIFY_CMP(_id, _op1, _op2)                                                                             \
    static kefir_result_t simplify_##_id(struct kefir_mem *mem, struct kefir_opt_function *func,                  \
                                         struct kefir_opt_instruction *instr,                                     \
                                         kefir_opt_instruction_ref_t *replacement_ref) {                          \
        const kefir_opt_block_id_t block_id = instr->block_id;                                                    \
        const kefir_opt_instruction_ref_t instr_id = instr->id;                                                   \
        ...
        if (arg2->operation.opcode == KEFIR_OPT_OPCODE_INT_CONST) {                                               \
            REQUIRE_OK(kefir_opt_code_builder_##_op1(mem, &func->code, block_id, arg1->id,                        \
                                                     arg2->operation.parameters.imm.integer, replacement_ref));   \
            REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref)); \
        } else if (arg2->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {                                       \
            REQUIRE_OK(kefir_opt_code_builder_##_op1(mem, &func->code, block_id, arg1->id,                        \
            ...
            REQUIRE_OK(kefir_opt_code_builder_##_op2(mem, &func->code, block_id, arg2->id,                        \
                                                     arg1->operation.parameters.imm.integer, replacement_ref));   \
            REQUIRE_OK(kefir_opt_code_container_instruction_move_after(&func->code, instr_id, *replacement_ref)); \
        } else if (arg1->operation.opcode == KEFIR_OPT_OPCODE_UINT_CONST) {                                       \
            REQUIRE_OK(kefir_opt_code_builder_##_op2(mem, &func->code, block_id, arg2->id,                        \
...
SIMPLIFY_CMP(int_equals, int_equals_const, int_equals_const)
SIMPLIFY_CMP(int_greater, int_greater_const, int_lesser_const)
SIMPLIFY_CMP(int_lesser, int_lesser_const, int_greater_const)
SIMPLIFY_CMP(int_above, int_above_const, int_below_const)
SIMPLIFY_CMP(int_below, int_below_const, int_above_const)
    ...
    for (struct kefir_opt_code_block *block = kefir_opt_code_container_iter(&func->code, &iter); block != NULL;
        ...
        for (kefir_opt_code_block_instr_head(&func->code, block, &instr); instr != NULL;) {
            ...
            switch (instr->operation.opcode) {
                ...
                case KEFIR_OPT_OPCODE_INT_EQUALS:
                    REQUIRE_OK(simplify_int_equals(mem, func, instr, &replacement_ref));
                    break;

                case KEFIR_OPT_OPCODE_INT_GREATER:
                    REQUIRE_OK(simplify_int_greater(mem, func, instr, &replacement_ref));
                    break;

                case KEFIR_OPT_OPCODE_INT_LESSER:
                    REQUIRE_OK(simplify_int_lesser(mem, func, instr, &replacement_ref));
                    break;

                case KEFIR_OPT_OPCODE_INT_ABOVE:
                    REQUIRE_OK(simplify_int_above(mem, func, instr, &replacement_ref));
                    break;

                case KEFIR_OPT_OPCODE_INT_BELOW:
                    REQUIRE_OK(simplify_int_below(mem, func, instr, &replacement_ref));
                    break;
