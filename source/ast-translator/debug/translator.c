...
static kefir_result_t translate_debug_type(struct kefir_mem *mem, const struct kefir_ast_context *context,
    ...
    switch (type->tag) {
        ...
        case KEFIR_AST_TYPE_SCALAR_UNSIGNED_INT128:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr,
                                                          &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("unsigned __int128")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_SIGNED_INT128:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr,
                                                          &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("signed __int128")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_INTERCHANGE_FLOAT32:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_new(mem, &module->debug_info.entries, KEFIR_IR_DEBUG_ENTRY_TYPE_FLOAT,
                                                entry_id_ptr));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr, &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("_Float32")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_INTERCHANGE_FLOAT64:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_new(mem, &module->debug_info.entries, KEFIR_IR_DEBUG_ENTRY_TYPE_FLOAT,
                                                entry_id_ptr));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr, &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("_Float64")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_EXTENDED_FLOAT32:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_new(mem, &module->debug_info.entries, KEFIR_IR_DEBUG_ENTRY_TYPE_FLOAT,
                                                entry_id_ptr));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr, &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("_Float32x")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_DECIMAL32:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr,
                                                          &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("_Decimal32")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_DECIMAL64:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr,
                                                          &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("_Decimal64")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
        ...
        case KEFIR_AST_TYPE_SCALAR_DECIMAL128:
            ...
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols,
                                                          *entry_id_ptr,
                                                          &KEFIR_IR_DEBUG_ENTRY_ATTR_NAME("_Decimal128")));
            REQUIRE_OK(
                kefir_ir_debug_entry_add_attribute(mem, &module->debug_info.entries, &module->symbols, *entry_id_ptr,
                                                   &KEFIR_IR_DEBUG_ENTRY_ATTR_SIZE(type_layout->properties.size)));
            REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
                    ...
                    case KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_REGISTER:
                        REQUIRE_OK(kefir_ir_debug_entry_add_attribute(
                            ...
                            &KEFIR_IR_DEBUG_ENTRY_ATTR_LOCAL_VARIABLE(
                                (((kefir_uint64_t) context->context_id) << 32) |
                                    (((kefir_uint64_t) scoped_identifier_layout->identifier) & ((1ull << 32) - 1)),
