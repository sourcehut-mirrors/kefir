...
kefir_result_t invoke_prologue(struct kefir_codegen_naive_amd64 *codegen,
                               const struct kefir_abi_amd64_function_decl *decl, struct invoke_info *info) {
...
kefir_result_t invoke_epilogue(struct kefir_codegen_naive_amd64 *codegen,
                               const struct kefir_abi_amd64_function_decl *decl, struct invoke_info *info,
                               bool virtualDecl) {
    REQUIRE_OK(KEFIR_AMD64_XASMGEN_INSTR_MOV(&codegen->xasmgen,
                                             kefir_asm_amd64_xasmgen_operand_reg(KEFIR_AMD64_XASMGEN_REGISTER_RSP),
...
kefir_result_t kefir_amd64_sysv_function_invoke(struct kefir_codegen_naive_amd64 *codegen,
