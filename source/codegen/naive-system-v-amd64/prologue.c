...
static kefir_result_t load_arguments(struct kefir_codegen_naive_amd64 *codegen,
                                     const struct kefir_amd64_sysv_function *sysv_func) {
...
static kefir_result_t save_registers(struct kefir_codegen_naive_amd64 *codegen,
                                     const struct kefir_amd64_sysv_function *sysv_func) {
    REQUIRE_OK(KEFIR_AMD64_XASMGEN_INSTR_LEA(
        &codegen->xasmgen, kefir_asm_amd64_xasmgen_operand_reg(KEFIR_AMD64_SYSV_ABI_DATA_REG),
        kefir_asm_amd64_xasmgen_operand_indirect(
...
kefir_result_t kefir_amd64_sysv_function_prologue(struct kefir_codegen_naive_amd64 *codegen,
