...
static kefir_result_t vararg_load_function_argument(
    const struct kefir_codegen_naive_amd64_sysv_builtin_type *builtin_type, const struct kefir_ir_typeentry *typeentry,
    struct kefir_codegen_naive_amd64 *codegen, const struct kefir_abi_amd64_function_parameter *parameter) {
    UNUSED(builtin_type);
    UNUSED(typeentry);
...
static kefir_result_t vararg_store_function_return(
    const struct kefir_codegen_naive_amd64_sysv_builtin_type *builtin_type, const struct kefir_ir_typeentry *typeentry,
    struct kefir_codegen_naive_amd64 *codegen, const struct kefir_abi_amd64_function_parameter *parameter) {
    UNUSED(builtin_type);
    UNUSED(typeentry);
...
static kefir_result_t vararg_store_function_argument(
    const struct kefir_codegen_naive_amd64_sysv_builtin_type *builtin_type, const struct kefir_ir_typeentry *typeentry,
    struct kefir_codegen_naive_amd64 *codegen, const struct kefir_abi_amd64_function_parameter *parameter,
...
static kefir_result_t vararg_load_function_return(
    const struct kefir_codegen_naive_amd64_sysv_builtin_type *builtin_type, const struct kefir_ir_typeentry *typeentry,
    struct kefir_codegen_naive_amd64 *codegen, const struct kefir_abi_amd64_function_parameter *parameter) {
    UNUSED(builtin_type);
    UNUSED(typeentry);
...
static kefir_result_t vararg_load_vararg_impl(struct kefir_codegen_naive_amd64 *codegen) {
...
static kefir_result_t vararg_load_vararg_appendix(struct kefir_codegen_naive_amd64 *codegen,
...
const struct kefir_codegen_naive_amd64_sysv_builtin_type KEFIR_CODEGEN_SYSTEM_V_AMD64_SYSV_BUILIN_VARARG_TYPE = {
