...
kefir_result_t kefir_amd64_sysv_instruction(struct kefir_mem *mem, struct kefir_codegen_naive_amd64 *codegen,
    ...
    *instr_width = 1;
    switch (instr->opcode) {
        ...
        case KEFIR_IROPCODE_INVOKE: {
            ...
            REQUIRE(kefir_codegen_naive_amd64_sysv_module_function_decl(mem, sysv_module, id, false),
        ...
        case KEFIR_IROPCODE_INVOKEV: {
            kefir_id_t id = (kefir_id_t) instr->arg.u64;
            REQUIRE(kefir_codegen_naive_amd64_sysv_module_function_decl(mem, sysv_module, id, true),
                    KEFIR_SET_ERROR(KEFIR_MEMALLOC_FAILURE,
                                    "Failed to allocate AMD64 System-V IR module function decaration"));
        ...
        case KEFIR_IROPCODE_BCOPY: {
            ...
            struct kefir_abi_amd64_type_layout *layout =
                kefir_codegen_naive_amd64_sysv_module_type_layout(mem, sysv_module, type_id);
        ...
        case KEFIR_IROPCODE_GETTHRLOCAL: {
            ...
            REQUIRE_OK(kefir_codegen_naive_amd64_sysv_module_declare_tls(mem, sysv_module, symbol));
        ...
        case KEFIR_IROPCODE_VARARG_END:
            return kefir_codegen_naive_amd64_sysv_vararg_instruction(mem, codegen, sysv_module, sysv_func, instr);
        ...
        case KEFIR_IROPCODE_INLINEASM: {
            ...
            REQUIRE_OK(kefir_codegen_naive_amd64_sysv_inline_assembly_invoke(mem, sysv_module, codegen, inline_asm));
        } break;
