...
static struct {
    ...
    HANDLER(LOAD16U),    HANDLER(LOAD16I),    HANDLER(LOAD32U),    HANDLER(LOAD32I),    HANDLER(LOAD64),
    HANDLER(LOADLD),     HANDLER(STORE8),     HANDLER(STORE16),    HANDLER(STORE32),    HANDLER(STORE64),
    HANDLER(STORELD),    HANDLER(BZERO),      HANDLER(BCOPY),      HANDLER(EXTUBITS),   HANDLER(EXTSBITS),
    HANDLER(INSERTBITS), HANDLER(GETLOCAL),   HANDLER(F32ADD),     HANDLER(F32SUB),     HANDLER(F32MUL),
