...
static kefir_result_t generate_subprogram_abbrev(struct kefir_mem *mem,
    ...
    REQUIRE_OK(kefir_ir_debug_entry_get_attribute(&codegen_function->generic.module->ir_module->debug_info.entries,
                                                  codegen_function->generic.function->ir_func->debug_info.subprogram_id,
    ...
    REQUIRE_OK(KEFIR_AMD64_DWARF_ATTRIBUTE_ABBREV(&codegen_function->codegen->xasmgen, KEFIR_DWARF(DW_AT_declaration),
                                                  KEFIR_DWARF(DW_FORM_flag)));
    REQUIRE_OK(KEFIR_AMD64_DWARF_ATTRIBUTE_ABBREV(&codegen_function->codegen->xasmgen, KEFIR_DWARF(DW_AT_linkage_name),
                                                  KEFIR_DWARF(DW_FORM_strp)));
...
static kefir_result_t generate_function_info(struct kefir_mem *mem,
    ...
    REQUIRE_OK(KEFIR_AMD64_XASMGEN_DATA(
        ...
        kefir_asm_amd64_xasmgen_operand_label(
            ...
            kefir_asm_amd64_xasmgen_helpers_format(&xasmgen_helpers[0], KEFIR_AMD64_FUNCTION_BEGIN,
    ...
    REQUIRE_OK(KEFIR_AMD64_XASMGEN_DATA(
        ...
        kefir_asm_amd64_xasmgen_operand_subtract(
            ...
            kefir_asm_amd64_xasmgen_operand_label(&xasmgen_helpers[0].operands[1], KEFIR_AMD64_XASMGEN_SYMBOL_ABSOLUTE,
                                                  kefir_asm_amd64_xasmgen_helpers_format(
                                                      &xasmgen_helpers[0], KEFIR_AMD64_FUNCTION_END,
                                                      codegen_function->codegen->symbol_prefix, ir_identifier->symbol)),
            kefir_asm_amd64_xasmgen_operand_label(
        ...
        kefir_asm_amd64_xasmgen_operand_subtract(
            ...
            kefir_asm_amd64_xasmgen_operand_label(
                ...
                kefir_asm_amd64_xasmgen_helpers_format(&codegen_function->codegen->xasmgen_helpers,
                                                       ...
                                                       codegen_function->codegen->symbol_prefix, return_type_id)),
            kefir_asm_amd64_xasmgen_operand_label(
                &codegen_function->codegen->xasmgen_helpers.operands[2], KEFIR_AMD64_XASMGEN_SYMBOL_ABSOLUTE,
                kefir_asm_amd64_xasmgen_helpers_format(&xasmgen_helpers[0], KEFIR_AMD64_DWARF_DEBUG_INFO_SECTION,
                                                       codegen_function->codegen->symbol_prefix)))));
    ...
    REQUIRE_OK(kefir_codegen_amd64_dwarf_generate_strp(
        mem, &codegen_function->codegen->xasmgen, context, codegen_function->codegen->symbol_prefix,
        ir_identifier->alias != NULL ? ir_identifier->alias : ir_identifier->symbol));
...
static kefir_result_t generate_function(struct kefir_mem *mem, struct kefir_codegen_amd64_function *codegen_function,
    ...
    KEFIR_DWARF_GENERATOR_SECTION(context->section, KEFIR_DWARF_GENERATOR_SECTION_ABBREV) {
        ...
        REQUIRE_OK(kefir_codegen_amd64_dwarf_generate_lexical_block_content(
            mem, codegen_function, context, liveness, codegen_function->generic.function->ir_func->debug_info.subprogram_id));
    }
