...
DEFINE_TRANSLATOR(copy_memory) {
    ...
    REQUIRE_OK(kefir_codegen_opt_amd64_sysv_storage_acquire(
        ...
        KEFIR_CODEGEN_OPT_AMD64_SYSV_STORAGE_ACQUIRE_SPECIFIC_REGISTER(KEFIR_AMD64_XASMGEN_REGISTER_RSI),
    ...
    struct kefir_codegen_opt_amd64_sysv_storage_location source_location_origin;
    ...
    kefir_result_t res = kefir_codegen_opt_amd64_sysv_storage_transform_insert(mem, &transform, &source_handle.location,
                                                                               &source_location_origin);
    ...
    REQUIRE_OK(kefir_codegen_opt_amd64_sysv_storage_acquire(
        mem, &codegen->xasmgen, &codegen_func->storage, &codegen_func->stack_frame_map,
        KEFIR_CODEGEN_OPT_AMD64_SYSV_STORAGE_ACQUIRE_SPECIFIC_REGISTER(KEFIR_AMD64_XASMGEN_REGISTER_RCX), NULL,
        &count_handle, NULL, NULL));
