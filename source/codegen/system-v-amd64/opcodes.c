...
static struct {
    ...
    HANDLER(LDTRUNC1),   HANDLER(F32CINT),   HANDLER(F64CINT),    HANDLER(F32CUINT),  HANDLER(F64CUINT),
    ...
    HANDLER(LDCUINT),    HANDLER(F32CLD),    HANDLER(F64CLD),     HANDLER(LDCF32),    HANDLER(LDCF64),
    HANDLER(PUSHSCOPE),  HANDLER(POPSCOPE),  HANDLER(SETLDH),     HANDLER(SETLDL)};
