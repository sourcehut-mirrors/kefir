...
kefir_result_t kefir_dfp_require_supported(const struct kefir_source_location *source_location) {
    if (source_location != NULL) {
        REQUIRE(kefir_dfp_is_supported(),
                KEFIR_SET_SOURCE_ERROR(KEFIR_NOT_SUPPORTED, source_location,
                                       "Decimal floating-point is not supported on current platform"));
    } else {
        REQUIRE(kefir_dfp_is_supported(),
                KEFIR_SET_ERROR(KEFIR_NOT_SUPPORTED, "Decimal floating-point is not supported on current platform"));
    }
    return KEFIR_OK;
}
...
kefir_dfp_decimal32_t kefir_dfp_decimal32_from_float(kefir_float32_t x) {
    UNUSED(x);
    FAIL_NOT_SUPPORTED;
}

kefir_dfp_decimal32_t kefir_dfp_decimal32_from_double(kefir_float64_t x) {
    UNUSED(x);
    FAIL_NOT_SUPPORTED;
}
...
kefir_dfp_decimal64_t kefir_dfp_decimal64_from_float(kefir_float32_t x) {
    UNUSED(x);
    FAIL_NOT_SUPPORTED;
}

kefir_dfp_decimal64_t kefir_dfp_decimal64_from_double(kefir_float64_t x) {
    UNUSED(x);
    FAIL_NOT_SUPPORTED;
}
...
kefir_dfp_decimal128_t kefir_dfp_decimal128_from_float(kefir_float32_t x) {
    UNUSED(x);
    FAIL_NOT_SUPPORTED;
}

kefir_dfp_decimal128_t kefir_dfp_decimal128_from_double(kefir_float64_t x) {
    UNUSED(x);
    FAIL_NOT_SUPPORTED;
}
...
kefir_dfp_decimal32_t kefir_dfp_decimal32_from_int64(kefir_int64_t x) {
    union decimal32_view view = {.decimal = (_Decimal32) x};
    return view.shim;
}
...
kefir_dfp_decimal64_t kefir_dfp_decimal64_from_int64(kefir_int64_t x) {
    union decimal64_view view = {.decimal = (_Decimal64) x};
    return view.shim;
}
...
kefir_dfp_decimal128_t kefir_dfp_decimal128_from_int64(kefir_int64_t x) {
    union decimal128_view view = {.decimal = (_Decimal128) x};
    return view.shim;
}
...
kefir_long_double_t kefir_dfp_decimal32_to_long_double(kefir_dfp_decimal32_t x) {
    union decimal32_view view = {.shim = x};
    return (kefir_long_double_t) view.decimal;
}

kefir_long_double_t kefir_dfp_decimal64_to_long_double(kefir_dfp_decimal64_t x) {
    union decimal64_view view = {.shim = x};
    return (kefir_long_double_t) view.decimal;
}

kefir_long_double_t kefir_dfp_decimal128_to_long_double(kefir_dfp_decimal128_t x) {
    union decimal128_view view = {.shim = x};
    return (kefir_long_double_t) view.decimal;
}

kefir_dfp_decimal32_t kefir_dfp_decimal32_from_decimal64(kefir_dfp_decimal64_t x) {
    union decimal64_view view = {.shim = x};
    union decimal32_view out_view = {.decimal = (_Decimal32) view.decimal};
...
kefir_dfp_decimal64_t kefir_dfp_decimal64_from_decimal32(kefir_dfp_decimal32_t x) {
    union decimal32_view view = {.shim = x};
    union decimal64_view out_view = {.decimal = (_Decimal64) view.decimal};
    return out_view.shim;
}
...
kefir_dfp_decimal128_t kefir_dfp_decimal128_from_decimal32(kefir_dfp_decimal32_t x) {
    union decimal32_view view = {.shim = x};
    union decimal128_view out_view = {.decimal = (_Decimal128) view.decimal};
    return out_view.shim;
}
...
kefir_dfp_decimal32_t kefir_dfp_decimal32_add(kefir_dfp_decimal32_t x, kefir_dfp_decimal32_t y) {
    union decimal32_view lhs_view =
                         ...
                         rhs_view = {.shim = y};
    union decimal32_view res_view = {.decimal = lhs_view.decimal + rhs_view.decimal};
...
kefir_dfp_decimal32_t kefir_dfp_decimal32_neg(kefir_dfp_decimal32_t x) {
    ...
    union decimal32_view res_view = {.decimal = -lhs_view.decimal};
    return res_view.shim;
}
...
kefir_dfp_decimal64_t kefir_dfp_decimal64_add(kefir_dfp_decimal64_t x, kefir_dfp_decimal64_t y) {
    union decimal64_view lhs_view =
                         ...
                         rhs_view = {.shim = y};
    union decimal64_view res_view = {.decimal = lhs_view.decimal + rhs_view.decimal};
    return res_view.shim;
}
...
kefir_dfp_decimal64_t kefir_dfp_decimal64_neg(kefir_dfp_decimal64_t x) {
    ...
    union decimal64_view res_view = {.decimal = -lhs_view.decimal};
    return res_view.shim;
}
...
kefir_dfp_decimal128_t kefir_dfp_decimal128_add(kefir_dfp_decimal128_t x, kefir_dfp_decimal128_t y) {
    union decimal128_view lhs_view =
                          ...
                          rhs_view = {.shim = y};
    union decimal128_view res_view = {.decimal = lhs_view.decimal + rhs_view.decimal};
    return res_view.shim;
}
...
kefir_dfp_decimal128_t kefir_dfp_decimal128_neg(kefir_dfp_decimal128_t x) {
    ...
    union decimal128_view res_view = {.decimal = -lhs_view.decimal};
    return res_view.shim;
}
...
kefir_dfp_decimal32_t kefir_dfp_decimal32_scan(const char *input) {
    union decimal32_view view = {.decimal = 0};
    SCAN_DECIMAL_IMPL(_Decimal32, -1, &view.decimal);
    return view.shim;
}

kefir_dfp_decimal64_t kefir_dfp_decimal64_scan(const char *input) {
    union decimal64_view view = {.decimal = 0};
    SCAN_DECIMAL_IMPL(_Decimal64, -1, &view.decimal);
    return view.shim;
}

kefir_dfp_decimal128_t kefir_dfp_decimal128_scan(const char *input) {
    union decimal128_view view = {.decimal = 0};
...
void kefir_dfp_decimal32_format(char *str, kefir_size_t len, kefir_dfp_decimal32_t value) {
    union decimal32_view view = {.shim = value};
    PRINT_DECIMAL_IMPL(str, len, &view.decimal, 7);
}

void kefir_dfp_decimal64_format(char *str, kefir_size_t len, kefir_dfp_decimal64_t value) {
    union decimal64_view view = {.shim = value};
    PRINT_DECIMAL_IMPL(str, len, &view.decimal, 16);
}

void kefir_dfp_decimal128_format(char *str, kefir_size_t len, kefir_dfp_decimal128_t value) {
    union decimal128_view view = {.shim = value};
