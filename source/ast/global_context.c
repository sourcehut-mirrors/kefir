...
static kefir_result_t context_define_tag(struct kefir_mem *mem, const struct kefir_ast_context *context,
    ...
    ASSIGN_DECL_CAST(struct kefir_ast_global_context *, global_ctx, context->payload);
    REQUIRE_OK(kefir_ast_global_context_define_tag(mem, global_ctx, type, attributes, location, NULL));
    return KEFIR_OK;
}
...
static kefir_result_t context_update_pragma_state(struct kefir_mem *mem, const struct kefir_ast_context *context,
    ...
    ASSIGN_DECL_CAST(struct kefir_ast_global_context *, global_ctx, context->payload);
    REQUIRE_OK(kefir_ast_pragma_state_merge(&global_ctx->pragmas, pragmas));
    return KEFIR_OK;
}
...
static kefir_result_t context_reset_pragma_state(struct kefir_mem *mem, const struct kefir_ast_context *context) {
    ...
    ASSIGN_DECL_CAST(struct kefir_ast_global_context *, global_ctx, context->payload);
    REQUIRE_OK(kefir_ast_pragma_state_init(&global_ctx->pragmas));
    return KEFIR_OK;
}
