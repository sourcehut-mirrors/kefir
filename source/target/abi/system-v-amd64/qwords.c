...
kefir_result_t kefir_abi_sysv_amd64_qwords_count(const struct kefir_ir_type *type, const struct kefir_vector *layout,
                                                 kefir_size_t *count) {
...
kefir_result_t kefir_abi_sysv_amd64_qwords_alloc(struct kefir_abi_sysv_amd64_qwords *qwords, struct kefir_mem *mem,
    ...
    REQUIRE_OK(kefir_vector_alloc(mem, sizeof(struct kefir_abi_sysv_amd64_qword), qword_count, &qwords->qwords));
    kefir_vector_extend(&qwords->qwords, qword_count);
    for (kefir_size_t i = 0; i < qword_count; i++) {
        ASSIGN_DECL_CAST(struct kefir_abi_sysv_amd64_qword *, qword, kefir_vector_at(&qwords->qwords, i));
...
kefir_result_t kefir_abi_sysv_amd64_qwords_free(struct kefir_abi_sysv_amd64_qwords *qwords, struct kefir_mem *mem) {
    REQUIRE(qwords != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_PARAMETER, "Expected valid QWord vector"));
...
static struct kefir_abi_sysv_amd64_qword *next_qword(struct kefir_abi_sysv_amd64_qwords *qwords,
                                                     kefir_size_t alignment) {
    ASSIGN_DECL_CAST(struct kefir_abi_sysv_amd64_qword *, qword, kefir_vector_at(&qwords->qwords, qwords->current));
    ...
    if (alignment == 0 || qword->current_offset + pad >= KEFIR_AMD64_SYSV_ABI_QWORD) {
        qwords->current++;
        qword = (struct kefir_abi_sysv_amd64_qword *) kefir_vector_at(&qwords->qwords, qwords->current);
    } else {
...
kefir_result_t kefir_abi_sysv_amd64_qwords_next(struct kefir_abi_sysv_amd64_qwords *qwords,
                                                kefir_abi_sysv_amd64_data_class_t dataclass, kefir_size_t size,
                                                kefir_size_t alignment, struct kefir_abi_sysv_amd64_qword_ref *ref) {
    REQUIRE(qwords != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_PARAMETER, "Expected valid QWord vector"));
    ...
    struct kefir_abi_sysv_amd64_qword *first = NULL;
    while (size > 0) {
        struct kefir_abi_sysv_amd64_qword *current = next_qword(qwords, alignment);
...
kefir_result_t kefir_abi_sysv_amd64_qwords_next_bitfield(struct kefir_abi_sysv_amd64_qwords *qwords,
                                                         kefir_abi_sysv_amd64_data_class_t dataclass,
                                                         kefir_size_t width,
                                                         struct kefir_abi_sysv_amd64_qword_ref *ref) {
    REQUIRE(qwords != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_PARAMETER, "Expected valid QWord vector"));
    ...
    struct kefir_abi_sysv_amd64_qword *first = NULL;
    while (size > 0) {
        struct kefir_abi_sysv_amd64_qword *current = next_qword(qwords, 1);
        REQUIRE(current != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_REQUEST, "Unable to obtain next qword"));
        if (first == NULL) {
            first = current;
            ref->qword = current;
...
kefir_result_t kefir_abi_sysv_amd64_qwords_reset_class(struct kefir_abi_sysv_amd64_qwords *qwords,
...
kefir_result_t kefir_abi_sysv_amd64_qwords_save_position(const struct kefir_abi_sysv_amd64_qwords *qwords,
                                                         struct kefir_abi_sysv_amd64_qword_position *position) {
    REQUIRE(qwords != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_PARAMETER, "Expected valid QWord vector"));
...
kefir_result_t kefir_abi_sysv_amd64_qwords_restore_position(
    struct kefir_abi_sysv_amd64_qwords *qwords, const struct kefir_abi_sysv_amd64_qword_position *position) {
    REQUIRE(qwords != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_PARAMETER, "Expected valid QWord vector"));
    REQUIRE(position != NULL, KEFIR_SET_ERROR(KEFIR_INVALID_PARAMETER, "Expected valid QWord position"));
    const kefir_size_t length = kefir_vector_length(&qwords->qwords);
...
kefir_result_t kefir_abi_sysv_amd64_qwords_max_position(const struct kefir_abi_sysv_amd64_qword_position *first,
                                                        const struct kefir_abi_sysv_amd64_qword_position *second,
                                                        struct kefir_abi_sysv_amd64_qword_position *result) {
