...
kefir_size_t kefir_abi_amd64_double_qword_size(kefir_abi_amd64_variant_t variant) {
    UNUSED(variant);
    return 1;
}

kefir_size_t kefir_abi_amd64_double_qword_alignment(kefir_abi_amd64_variant_t variant) {
    UNUSED(variant);
    return 1;
}
...
kefir_size_t kefir_abi_amd64_fenv_qword_size(kefir_abi_amd64_variant_t variant) {
    UNUSED(variant);
    return 4;
}

kefir_size_t kefir_abi_amd64_fenv_qword_alignment(kefir_abi_amd64_variant_t variant) {
    UNUSED(variant);
    return 1;
}
