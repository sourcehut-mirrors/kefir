KEFIR_LIB_SOURCE := $(wildcard \
	...
	$(SOURCE_DIR)/codegen/target-ir/amd64/transform/peephole/*.c \
...
BIN_HEADERS_INCDIR=$(HEADERS_DIR)
BIN_HEADERS_CC=$(CC)
...
$(LIBKEFIR_SO).$(LIBKEFIR_SO_VERSION): $(KEFIR_LIB_OBJECT_FILES)
	...
	@echo "Linking $@"
	@$(CCLD) -shared -o $@ $(KEFIR_LIB_OBJECT_FILES) $(LDFLAGS) -Wl,-soname=$(shell basename "$@")
