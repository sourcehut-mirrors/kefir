...
const char *KEFIR_PARSER_SUPPORTED_BUILTINS[] = {KEFIR_PARSER_BUILTIN_VA_START,
                                                 ...
                                                 KEFIR_PARSER_BUILTIN_KEFIR_INFD32,
                                                 KEFIR_PARSER_BUILTIN_KEFIR_NAND32,
...
static const struct {
    ...
    {KEFIR_PARSER_BUILTIN_VA_START, KEFIR_AST_BUILTIN_VA_START},
    ...
    {KEFIR_PARSER_BUILTIN_KEFIR_ISINF, KEFIR_AST_BUILTIN_KEFIR_ISINF},
    {KEFIR_PARSER_BUILTIN_KEFIR_COPYSIGNF, KEFIR_AST_BUILTIN_KEFIR_COPYSIGNF},
    {KEFIR_PARSER_BUILTIN_KEFIR_COPYSIGN, KEFIR_AST_BUILTIN_KEFIR_COPYSIGN},
    {KEFIR_PARSER_BUILTIN_KEFIR_COPYSIGNL, KEFIR_AST_BUILTIN_KEFIR_COPYSIGNL},
    {KEFIR_PARSER_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_FLOAT, KEFIR_AST_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_FLOAT},
    {KEFIR_PARSER_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_DOUBLE, KEFIR_AST_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_DOUBLE},
    {KEFIR_PARSER_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_LONG_DOUBLE, KEFIR_AST_BUILTIN_KEFIR_CONSTRUCT_COMPLEX_LONG_DOUBLE},
    {KEFIR_PARSER_BUILTIN_KEFIR_ISFINITE, KEFIR_AST_BUILTIN_KEFIR_ISFINITE},
    {KEFIR_PARSER_BUILTIN_KEFIR_INFD32, KEFIR_AST_BUILTIN_KEFIR_INFD32},
