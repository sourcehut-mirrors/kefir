...
#define TYPE_FMT_bitint_ref2 u64
...
#define TYPE_FMT_ref_index2 u64_2
...
#define TYPE_FMT_bitint_atomic bitint_atomic
#define TYPE_FMT_bitint_bitfield bitint_bitfield
