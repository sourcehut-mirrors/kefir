...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ir_inline_assembly_add_parameter(
        mem, &module.symbols, inline_asm1, "p1", KEFIR_IR_INLINE_ASSEMBLY_PARAMETER_WRITE,
        KEFIR_IR_INLINE_ASSEMBLY_PARAMETER_CONSTRAINT_REGISTER, decl_params, 0, 0, 0));
    REQUIRE_OK(kefir_ir_inline_assembly_add_parameter(
        mem, &module.symbols, inline_asm1, "p2", KEFIR_IR_INLINE_ASSEMBLY_PARAMETER_WRITE,
        KEFIR_IR_INLINE_ASSEMBLY_PARAMETER_CONSTRAINT_REGISTER, decl_params, 0, 0, 1));
    REQUIRE_OK(kefir_ir_inline_assembly_add_parameter(
    ...
    REQUIRE_OK(kefir_ir_inline_assembly_add_parameter(
        ...
        KEFIR_IR_INLINE_ASSEMBLY_PARAMETER_CONSTRAINT_REGISTER, decl_params, 0, 2, 0));
