...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_irbuilder_type_append(mem, decl_params, KEFIR_IR_TYPE_LONG, 0, 2));
    ...
    REQUIRE_OK(kefir_ir_inline_assembly_add_parameter(
        ...
        &(struct kefir_ir_inline_assembly_parameter_constraints) { .memory_location = true }, decl_params, func_params, 0, 0, NULL));
    REQUIRE_OK(kefir_ir_inline_assembly_add_parameter(
