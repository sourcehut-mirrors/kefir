...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ast_structure_declaration_entry_append(
        ...
        kefir_ast_declarator_array_noarena(mem, KEFIR_AST_DECLARATOR_ARRAY_BOUNDED,
                                   ...
                                   kefir_ast_declarator_identifier_noarena(mem, global_context.context.symbols, "content")),
        NULL));
    ...
    struct kefir_ast_initializer *init1_1_1 = kefir_ast_new_list_initializer_noarena(mem);
    REQUIRE_OK(kefir_ast_initializer_list_append(
    ...
    struct kefir_ast_initializer *init1_2_1 = kefir_ast_new_list_initializer_noarena(mem);
    REQUIRE_OK(kefir_ast_initializer_list_append(
        mem, &init1_2_1->list,
    ...
    REQUIRE_OK(kefir_ast_initializer_list_append(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 12)))));
    ...
    REQUIRE_OK(kefir_ast_initializer_list_append(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 16)))));
    REQUIRE_OK(kefir_ast_initializer_list_append(
        mem, &init1_3->list, NULL,
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 17)))));
    REQUIRE_OK(
        kefir_ast_initializer_list_append(mem, &init1->list,
                                          kefir_ast_new_initializer_member_designation_noarena(
                                              ...
                                              kefir_ast_new_initializer_index_designation_noarena(
                                                  mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 3)), NULL)),
                                          init1_3));
    ...
    REQUIRE_OK(kefir_ast_initializer_list_append(
        ...
        kefir_ast_new_initializer_index_designation_noarena(
            ...
            kefir_ast_new_initializer_member_designation_noarena(
                ...
                kefir_ast_new_initializer_index_designation_noarena(
                    mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 3)), NULL))),
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 19)))));

    REQUIRE_OK(kefir_ast_initializer_list_append(
        mem, &init1->list, NULL,
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 20)))));
    ...
    struct kefir_ast_declaration *decl1 = kefir_ast_new_single_declaration_noarena(
        ...
        kefir_ast_declarator_array_noarena(mem, KEFIR_AST_DECLARATOR_ARRAY_UNBOUNDED, NULL,
                                   kefir_ast_declarator_identifier_noarena(mem, global_context.context.symbols, "array")),
        init1, NULL);
    ...
    REQUIRE_OK(kefir_ast_initializer_list_append(
        ...
        kefir_ast_new_initializer_index_designation_noarena(
            ...
            kefir_ast_new_initializer_member_designation_noarena(
                mem, global_context.context.symbols, "content",
                kefir_ast_new_initializer_index_designation_noarena(
                    mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 0)), NULL))),
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 1)))));
    REQUIRE_OK(kefir_ast_initializer_list_append(
        mem, &init2->list, NULL,
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 2)))));
