...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ast_global_context_define_external(
        ...
        kefir_ast_alignment_as_type(mem, kefir_ast_type_char()), NULL, NULL, NULL, NULL));
    ...
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context, "global_var100",
                                                        kefir_ast_type_unsigned_char(), NULL, NULL, NULL, NULL));
    ...
    REQUIRE_OK(
        kefir_ast_local_context_define_auto(mem, &local_context, "local_var1", type1, NULL, NULL, NULL, NULL, NULL));
