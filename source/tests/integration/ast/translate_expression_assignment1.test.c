...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context, "bool", kefir_ast_type_boolean(), NULL,
                                                        NULL, NULL, NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context, "char", kefir_ast_type_char(), NULL, NULL,
                                                        NULL, NULL));
    ...
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context, "double", kefir_ast_type_double(), NULL,
                                                        NULL, NULL, NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context, "enum", type1, NULL, NULL, NULL, NULL));
    REQUIRE_OK(kefir_ast_local_context_declare_external(mem, &local_context, "ptr", type2, NULL, NULL, NULL, NULL));
