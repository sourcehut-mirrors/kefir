...
static kefir_result_t evaluate_extension_node(struct kefir_mem *mem, const struct kefir_ast_context *context,
    ...
    value->integer = (kefir_uptr_t) ext_node->payload;
    return KEFIR_OK;
}
...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ast_context_extensions analysis_ext = {.analyze_extension_node = analyze_extension_node,
                                                        .evaluate_constant_extension_node = evaluate_extension_node};
