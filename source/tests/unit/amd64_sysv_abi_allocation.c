...
DEFINE_CASE(amd64_sysv_abi_allocation_test1, "AMD64 System V ABI - parameter allocation") {
    ...
    struct kefir_abi_sysv_amd64_parameter_location location = {0};
    ASSERT_OK(kefir_abi_sysv_amd64_parameter_allocate(&kft_mem, &type, &layout, &allocation, &location));
...
DEFINE_CASE(amd64_sysv_abi_allocation_test6, "AMD64 System V ABI - parameter allocation #6") {
    ...
    struct kefir_abi_sysv_amd64_parameter_location location = {0};
    ASSERT_OK(kefir_abi_sysv_amd64_parameter_allocate(&kft_mem, &type2, &layout, &allocation, &location));
