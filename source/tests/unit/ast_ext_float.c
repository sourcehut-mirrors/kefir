...
DEFINE_CASE(ast_interchange_float_types1, "AST Type analysis - interchange float types #1") {
...
DEFINE_CASE(ast_interchange_float_types2, "AST Type analysis - interchange float types #2") {
    const struct kefir_ast_type_traits *type_traits = kefir_util_default_type_traits();
