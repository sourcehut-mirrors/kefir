...
DEFINE_CASE(bigint_float_to_unsigned1, "BigInt - float to unsigned conversion #1") {
    struct kefir_bigint bigint;
...
#define ASSERT_CAST(_arg, _width)                                                                            \
    do {                                                                                                     \
        ASSERT_OK(kefir_bigint_resize_nocast(&kft_mem, &bigint, sizeof(kefir_uint##_width##_t) * CHAR_BIT)); \
                                                                                                             \
        ASSERT_OK(kefir_bigint_unsigned_from_float(&bigint, (_arg)));                                        \
        ASSERT_ULOAD(&bigint, (kefir_uint##_width##_t)(_arg));                                               \
    } while (0)

    for (kefir_float32_t i = 0.0f; i < 200.0f; i += 0.25f) {
        ASSERT_CAST(i, 8);
        ASSERT_CAST(i * 1e-1f, 8);
        ASSERT_CAST(i, 16);
        ASSERT_CAST(i * 1e-1f, 16);
    ...
    ASSERT_CAST((kefir_float32_t) KEFIR_UINT8_MAX, 8);
    ASSERT_CAST((kefir_float32_t) KEFIR_UINT8_MAX, 16);
    ASSERT_CAST((kefir_float32_t) KEFIR_UINT8_MAX, 32);
    ASSERT_CAST((kefir_float32_t) KEFIR_UINT8_MAX, 64);
...
#define ASSERT_CAST(_arg, _width)                                                                            \
    ...
    for (kefir_float64_t i = 0.0; i < 200.0; i += 0.25) {
        ASSERT_CAST(i, 8);
        ASSERT_CAST(i * 1e-1, 8);
        ASSERT_CAST(i, 16);
        ASSERT_CAST(i * 1e-1, 16);
...
DEFINE_CASE(bigint_long_double_to_unsigned1, "BigInt - long double to unsigned conversion #1") {
    struct kefir_bigint bigint;
...
#define ASSERT_CAST(_arg, _width)                                                                            \
    do {                                                                                                     \
        ASSERT_OK(kefir_bigint_resize_nocast(&kft_mem, &bigint, sizeof(kefir_uint##_width##_t) * CHAR_BIT)); \
                                                                                                             \
        ASSERT_OK(kefir_bigint_unsigned_from_long_double(&bigint, (_arg)));                                  \
        ASSERT_ULOAD(&bigint, (kefir_uint##_width##_t)(_arg));                                               \
    } while (0)

    for (kefir_long_double_t i = 0.0L; i < 200.0L; i += 0.25L) {
        ASSERT_CAST(i, 8);
        ASSERT_CAST(i * 1e-1, 8);
        ASSERT_CAST(i, 16);
        ASSERT_CAST(i * 1e-1, 16);
    ...
    ASSERT_CAST((kefir_long_double_t) KEFIR_UINT8_MAX, 8);
    ASSERT_CAST((kefir_long_double_t) KEFIR_UINT8_MAX, 16);
    ASSERT_CAST((kefir_long_double_t) KEFIR_UINT8_MAX, 32);
    ASSERT_CAST((kefir_long_double_t) KEFIR_UINT8_MAX, 64);
    ASSERT_CAST((kefir_long_double_t) KEFIR_UINT16_MAX, 16);
    ASSERT_CAST((kefir_long_double_t) KEFIR_UINT16_MAX, 32);
...
DEFINE_CASE(bigint_redundant_sign_bits1, "BigInt - redundant sign bits #1") {
    struct kefir_bigint bigint;
    ...
    kefir_size_t count;
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 0));
    ASSERT_OK(kefir_bigint_redundant_sign_bits(&bigint, &count));
    ASSERT(count == 6);
    ...
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 1));
    ASSERT_OK(kefir_bigint_left_shift(&bigint, 4));
    ASSERT_OK(kefir_bigint_redundant_sign_bits(&bigint, &count));
    ASSERT(count == 1);
    ...
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 1));
    ASSERT_OK(kefir_bigint_negate(&bigint));
    ASSERT_OK(kefir_bigint_right_shift(&bigint, 2));
    ASSERT_OK(kefir_bigint_redundant_sign_bits(&bigint, &count));
    ASSERT(count == 1);

    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 1));
    ASSERT_OK(kefir_bigint_negate(&bigint));
    ASSERT_OK(kefir_bigint_right_shift(&bigint, 3));
    ASSERT_OK(kefir_bigint_redundant_sign_bits(&bigint, &count));
    ASSERT(count == 2);

    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 1));
    ASSERT_OK(kefir_bigint_negate(&bigint));
    ASSERT_OK(kefir_bigint_right_shift(&bigint, 4));
    ASSERT_OK(kefir_bigint_redundant_sign_bits(&bigint, &count));
    ASSERT(count == 3);
...
DEFINE_CASE(bigint_nonzero_count1, "BigInt - nonzero bit count #1") {
    struct kefir_bigint bigint;
    ...
    kefir_size_t count;
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 0));
    ASSERT_OK(kefir_bigint_nonzero_count(&bigint, &count));
    ASSERT(count == 0);
    ...
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 3));
    ASSERT_OK(kefir_bigint_left_shift(&bigint, 2));
    ASSERT_OK(kefir_bigint_nonzero_count(&bigint, &count));
    ASSERT(count == 2);

    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 7));
    ASSERT_OK(kefir_bigint_left_shift(&bigint, 1));
    ASSERT_OK(kefir_bigint_nonzero_count(&bigint, &count));
    ASSERT(count == 3);
    ...
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 1));
    ASSERT_OK(kefir_bigint_left_shift(&bigint, 150));
    ASSERT_OK(kefir_bigint_nonzero_count(&bigint, &count));
    ASSERT(count == 1);

    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 255));
    ASSERT_OK(kefir_bigint_left_shift(&bigint, 250));
    ASSERT_OK(kefir_bigint_nonzero_count(&bigint, &count));
    ASSERT(count == 8);
    ...
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 1));
    ASSERT_OK(kefir_bigint_negate(&bigint));
    ASSERT_OK(kefir_bigint_right_shift(&bigint, 490));
    ASSERT_OK(kefir_bigint_nonzero_count(&bigint, &count));
    ASSERT(count == 10);
...
DEFINE_CASE(bigint_parity1, "BigInt - parity #1") {
    struct kefir_bigint bigint;
    ...
    kefir_size_t count;
    ASSERT_OK(kefir_bigint_set_unsigned_value(&bigint, 0));
    ASSERT_OK(kefir_bigint_parity(&bigint, &count));
    ASSERT(count == 0);
