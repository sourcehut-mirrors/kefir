...
DEFINE_CASE(ast_ordinary_scope_objects_local_init1, "AST Declaration initializers - local static") {
    ...
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "var3", type1, NULL, NULL, NULL, NULL, NULL));
    ASSERT_OK(kefir_ast_local_context_define_static(&kft_mem, &context, "var3", type2, NULL, NULL, NULL, NULL, NULL));
    ...
    ASSERT_NOK(kefir_ast_local_context_define_static(&kft_mem, &context, "var4", type2, NULL, NULL, NULL, NULL, NULL));
...
DEFINE_CASE(ast_ordinary_scope_objects_local_init2, "AST Declaration initializers - local thread local static") {
    ...
    ASSERT_NOK(kefir_ast_local_context_define_static_thread_local(
        &kft_mem, &context, "var2", kefir_ast_type_signed_char(), NULL, NULL, NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var2", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_STATIC_THREAD_LOCAL,
                               kefir_ast_type_signed_char(), KEFIR_AST_SCOPED_IDENTIFIER_NONE_LINKAGE);
...
DEFINE_CASE(ast_ordinary_scope_objects_local_init3, "AST Declaration initializers - local auto") {
    ...
    ASSERT_NOK(kefir_ast_local_context_define_auto(&kft_mem, &context, "var3", type1, NULL, NULL, NULL, NULL, NULL));

    ASSERT_OK(kefir_ast_local_context_define_auto(&kft_mem, &context, "var3", type2, NULL, NULL, NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var3", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_AUTO, type2,
                               KEFIR_AST_SCOPED_IDENTIFIER_NONE_LINKAGE);

    ASSERT_NOK(kefir_ast_local_context_define_auto(&kft_mem, &context, "var3", type2, NULL, NULL, NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var3", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_AUTO, type2,
                               KEFIR_AST_SCOPED_IDENTIFIER_NONE_LINKAGE);
...
DEFINE_CASE(ast_ordinary_scope_objects_local_init4, "AST Declaration initializers - local register") {
    ...
    ASSERT_NOK(
        kefir_ast_local_context_define_register(&kft_mem, &context, "var3", type1, NULL, NULL, NULL, NULL, NULL));

    ASSERT_OK(kefir_ast_local_context_define_register(&kft_mem, &context, "var3", type2, NULL, NULL, NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var3", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_REGISTER, type2,
                               KEFIR_AST_SCOPED_IDENTIFIER_NONE_LINKAGE);

    ASSERT_NOK(
        kefir_ast_local_context_define_register(&kft_mem, &context, "var3", type2, NULL, NULL, NULL, NULL, NULL));
    ASSERT_RESOLVED_IDENTIFIER(&context, "var3", KEFIR_AST_SCOPE_IDENTIFIER_STORAGE_REGISTER, type2,
                               KEFIR_AST_SCOPED_IDENTIFIER_NONE_LINKAGE);
