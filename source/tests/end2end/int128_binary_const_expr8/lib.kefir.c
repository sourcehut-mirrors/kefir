...
int cmps[] = {((unsigned __int128) 0) <= ((unsigned __int128) 100),
              ...
              1000 <= ((unsigned __int128) 1000),
              1000 <= ((signed __int128) 1000),
              ((unsigned __int128) 1000) <= ((signed __int128) 1000),
              ((signed __int128) 1000) <= 1000,
              ((signed __int128) 1000) <= ((unsigned __int128) 1000),
              ((unsigned __int128) 1000) <= ((signed __int128) 1000)};
