...
_Decimal32 fi32_to_d32(float);
_Decimal64 fi32_to_d64(float);
_Decimal128 fi32_to_d128(float);
float d32_to_fi32(_Decimal32);
float d64_to_fi32(_Decimal64);
float d128_to_fi32(_Decimal128);
...
int main(void) {
    ...
    assert(decimal32_eq(fi32_to_d32(3.14159), 0.0));
    assert(decimal64_eq(fi32_to_d64(3.14159), 0.0));
    assert(decimal128_eq(fi32_to_d128(3.14159), 0.0));

    assert(fabs(d32_to_fi32(3.14159)) < 1e-6);
    assert(fabs(d64_to_fi32(3.14159)) < 1e-6);
    assert(fabs(d128_to_fi32(3.14159)) < 1e-6);
#endif
    return EXIT_SUCCESS;
}
