...
$(KEFIR_END2END_BIN_PATH)/%.test: $(LIBKEFIRRT_A) $$(KEFIR_END2END_TEST_HOST_OBJECT_FILES) $$(KEFIR_END2END_TEST_KEFIR_OBJECT_FILES)
	@mkdir -p $(shell dirname "$@")
	@echo "Linking $@"
	@$(CC) $(TEST_CFLAGS) $(SANITIZER_FLAGS) $(KEFIR_END2END_TEST_HOST_OBJECT_FILES) $(KEFIR_END2END_TEST_KEFIR_OBJECT_FILES) $(LIBKEFIRRT_A) -o $@ $(KEFIR_END2END_TEST_LIBS) -lm -latomic
