...
$(KEFIR_END2END_BIN_PATH)/$(END2END_TEST_ID).test: $(END2END_$(END2END_TEST_ID)_OBJECTS)
$(KEFIR_END2END_BIN_PATH)/$(END2END_TEST_ID).test: KEFIR_END2END_TEST_OBJS := $(END2END_$(END2END_TEST_ID)_OBJECTS)

ifneq ($(END2END_$(END2END_TEST_ID)_KEFIR_SOURCES),)
DEPENDENCIES += $(END2END_$(END2END_TEST_ID)_DEPENDENCIES)
OBJECT_FILES += $(END2END_$(END2END_TEST_ID)_OBJECTS)
TEST_BINARIES += $(KEFIR_END2END_BIN_PATH)/$(END2END_TEST_ID).test
TESTS += $(KEFIR_END2END_BIN_PATH)/$(END2END_TEST_ID).test.done
endif
...
# Also-asmgen tests
END2END_$(END2END_TEST_ID)_ALSO_ASMGEN_MARKS=$(wildcard \
	$(SOURCE_DIR)/tests/end2end/$(END2END_TEST_ID)/*.kefir.also.asmgen)

END2END_$(END2END_TEST_ID)_ASMGEN_TEST_EXPECTED += $(END2END_$(END2END_TEST_ID)_ALSO_ASMGEN_MARKS:$(SOURCE_DIR)/%.kefir.also.asmgen=$(SOURCE_DIR)/%.also.asmgen.expected)
END2END_$(END2END_TEST_ID)_ASMGEN_TEST_RESULTS += $(END2END_$(END2END_TEST_ID)_ALSO_ASMGEN_MARKS:$(SOURCE_DIR)/%.kefir.also.asmgen=$(BIN_DIR)/%.also.asmgen.output)
END2END_$(END2END_TEST_ID)_ASMGEN_TESTS += $(END2END_$(END2END_TEST_ID)_ALSO_ASMGEN_MARKS:$(SOURCE_DIR)/%.kefir.also.asmgen=$(BIN_DIR)/%.test.also.asmgen.done)
