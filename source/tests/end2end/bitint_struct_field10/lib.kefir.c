...
struct S1 {
    ...
    unsigned _BitInt(40) d : 30;
    unsigned _BitInt(29) e : 25;
    unsigned _BitInt(15) f : 8;
    unsigned _BitInt(120) g : 23;
    unsigned _BitInt(33) h : 15;
    unsigned _BitInt(6) i : 4;
};
...
struct S2 {
    unsigned _BitInt(400) a : 80, b : 120, c : 100;
};
