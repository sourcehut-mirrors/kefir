...
int f64_compat[] = {CLASSIFY((_Imaginary double) 1.0if),
...
extern long f64_iarr[] = {(_Imaginary double) 54.241if, (_Bool) (_Imaginary double) 0.0if,
                          (_Bool) (_Imaginary double) 9.4929if, (long) (_Imaginary double) -9.4929if,
...
_Imaginary double f64_ops[] = {((_Imaginary double) 3.0if) + ((_Imaginary double) 9.0if),
...
double f64_ops2[] = {((_Imaginary double) 3.0if) + ((_Imaginary double) 9.0if),
                     ((_Imaginary double) 3.0if) + ((double) 9.0f),
                     ((double) 3.0f) + ((_Imaginary double) 9.0if),
                     ((_Imaginary double) 3.0if) + ((_Complex double) 6.0f + 9.0if),
                     ((_Complex double) 6.0f + 9.0if) + ((_Imaginary double) -3.0if),
