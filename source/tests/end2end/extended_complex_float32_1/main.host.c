...
int main(void) {
    assert(f32_size == sizeof(_Complex double));
    assert(f32_alignment == _Alignof(_Complex double));
    ...
    int i = 0;
    assert(fabs(creal(f32[i]) - ((double) 3.14159f)) < 1e-6);
    assert(fabs(cimag(f32[i++]) - ((double) -123.1f)) < 1e-6);
    assert(fabs(creal(f32[i]) - (-((double) 1902.318f))) < 1e-6);
    assert(fabs(cimag(f32[i++]) - ((double) 90.4)) < 1e-5);
    ...
    assert(fabs(cimag(f32[i++]) - cimag(exp)) < 1e-4);
    exp = ((_Complex double) 273.3f - 638.1 * I) - ((_Complex double) 1902.318f + 90.31 * I);
    assert(fabs(creal(f32[i]) - creal(exp)) < 1e-6);
    assert(fabs(cimag(f32[i++]) - cimag(exp)) < 1e-4);
    exp = ((_Complex double) 273.3f - 638.1 * I) * ((_Complex double) 1902.318f + 90.31 * I);
    assert(fabs(creal(f32[i]) - creal(exp)) < 1e-2);
    assert(fabs(cimag(f32[i++]) - cimag(exp)) < 1e-1);
    exp = ((_Complex double) 273.3f - 638.1 * I) / ((_Complex double) 1902.318f + 90.31 * I);
    assert(fabs(creal(f32[i]) - creal(exp)) < 1e-6);
    ...
    assert(fabs(cimag(f32[i++]) - cimag(exp)) < 1e-4);
    exp = ((double) 273.3f - 99.3145 * I) * ((_Complex double) 1902.318f + 1.0004e6 * I),
    assert(fabs(creal(f32[i]) - creal(exp)) < 1e1);
    assert(fabs(cimag(f32[i++]) - cimag(exp)) < 1e-2);
    exp = ((double) 273.3f - 99.3145 * I) / ((_Complex double) 1902.318f + 1.0004e6 * I);
    assert(fabs(creal(f32[i]) - creal(exp)) < 1e-6);
    assert(fabs(cimag(f32[i++]) - cimag(exp)) < 1e-2);

    _Complex double res = get32_1();
    exp = 5.428f - 8842.3 * I;
