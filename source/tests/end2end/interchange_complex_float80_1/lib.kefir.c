...
_Complex _Float80 get80_2(void) {
    return f80_const;
}

_Complex _Float80 neg80(_Complex _Float80 x) {
    return -x;
}

_Complex _Float80 add80(_Complex _Float80 x, _Complex _Float80 y) {
    return x + y;
}

_Complex _Float80 sub80(_Complex _Float80 x, _Complex _Float80 y) {
    return x - y;
}

_Complex _Float80 mul80(_Complex _Float80 x, _Complex _Float80 y) {
    return x * y;
}

_Complex _Float80 div80(_Complex _Float80 x, _Complex _Float80 y) {
    return x / y;
}

_Complex _Float80 conv1(long x) {
    return x;
}

_Complex _Float80 conv2(unsigned long x) {
    return x;
}

_Complex _Float80 conv3(float x) {
    return x;
}

_Complex _Float80 conv4(double x) {
    return x;
}

_Complex _Float80 conv5(long double x) {
    return x;
}

_Complex _Float80 conv6(_Complex float x) {
    return x;
}

_Complex _Float80 conv7(_Complex double x) {
    return x;
}

_Complex _Float80 conv8(_Complex long double x) {
    return x;
}
