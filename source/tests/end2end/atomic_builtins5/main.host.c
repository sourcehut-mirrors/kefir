...
int main(void) {
    for (long x = -1024; x < 1024; x++) {
        for (long y = -260; y < 260; y++) {
            ...
            assert(chr == (char) (x + y));
            assert(test_fetch_add_short(&shrt, (short) y) == (short) x);
            assert(shrt == (short) (x + y));
            assert(test_fetch_add_int(&integer, (int) y) == (int) x);
            ...
            assert(chr == (char) (x - y));
            assert(test_fetch_sub_short(&shrt, (short) y) == (short) x);
            assert(shrt == (short) (x - y));
            assert(test_fetch_sub_int(&integer, (int) y) == (int) x);
            assert(integer == (int) (x - y));
            ...
            assert(chr == (char) (x | y));
            assert(test_fetch_or_short(&shrt, (short) y) == (short) x);
            assert(shrt == (short) (x | y));
            assert(test_fetch_or_int(&integer, (int) y) == (int) x);
            assert(integer == (int) (x | y));
            ...
            assert(chr == (char) (x & y));
            assert(test_fetch_and_short(&shrt, (short) y) == (short) x);
            assert(shrt == (short) (x & y));
            assert(test_fetch_and_int(&integer, (int) y) == (int) x);
            assert(integer == (int) (x & y));
            ...
            assert(chr == (char) (x ^ y));
            assert(test_fetch_xor_short(&shrt, (short) y) == (short) x);
            assert(shrt == (short) (x ^ y));
            assert(test_fetch_xor_int(&integer, (int) y) == (int) x);
            assert(integer == (int) (x ^ y));
