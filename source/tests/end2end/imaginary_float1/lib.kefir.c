...
int f32_compat[] = {CLASSIFY((_Imaginary float) 1.0if),
...
extern long f32_iarr[] = {(_Imaginary float) 54.241if, (_Bool) (_Imaginary float) 0.0if,
                          (_Bool) (_Imaginary float) 9.4929if, (long) (_Imaginary float) -9.4929if,
...
_Imaginary float f32_ops[] = {((_Imaginary float) 3.0if) + ((_Imaginary float) 9.0if),
...
float f32_ops2[] = {((_Imaginary float) 3.0if) + ((_Imaginary float) 9.0if),
                    ((_Imaginary float) 3.0if) + ((float) 9.0f),
                    ((float) 3.0f) + ((_Imaginary float) 9.0if),
                    ((_Imaginary float) 3.0if) + ((_Complex float) 6.0f + 9.0if),
                    ((_Complex float) 6.0f + 9.0if) + ((_Imaginary float) -3.0if),
