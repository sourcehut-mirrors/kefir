...
int main(void) {
    ...
    assert(test1(1ull << (sizeof(char) * CHAR_BIT - 1)) == 0);
    assert(test1((unsigned char) (1ull << (sizeof(char) * CHAR_BIT))) == (sizeof(char) * CHAR_BIT - 1));
    ...
    assert(test2(1ull << (sizeof(short) * CHAR_BIT - 1)) == 0);
    assert(test2((unsigned short) (1ull << (sizeof(short) * CHAR_BIT))) == (sizeof(short) * CHAR_BIT - 1));
    ...
    assert(test3(1ull << (sizeof(int) * CHAR_BIT - 1)) == 0);
    assert(test3((unsigned int) (1ull << (sizeof(int) * CHAR_BIT))) == (sizeof(int) * CHAR_BIT - 1));
