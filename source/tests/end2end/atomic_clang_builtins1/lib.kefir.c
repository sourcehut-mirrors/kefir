...
_Bool test_is_lock_free(void) {
    return __c11_atomic_is_lock_free((_Bool *) 0) == __CLANG_ATOMIC_BOOL_LOCK_FREE &&
           ...
           __c11_atomic_is_lock_free((__CHAR16_TYPE__ *) 0) == __CLANG_ATOMIC_CHAR16_T_LOCK_FREE &&
           __c11_atomic_is_lock_free((__CHAR32_TYPE__ *) 0) == __CLANG_ATOMIC_CHAR32_T_LOCK_FREE &&
           __c11_atomic_is_lock_free((__WCHAR_TYPE__ *) 0) == __CLANG_ATOMIC_WCHAR_T_LOCK_FREE &&
           __c11_atomic_is_lock_free((short *) 0) == __CLANG_ATOMIC_SHORT_LOCK_FREE &&
           __c11_atomic_is_lock_free((int *) 0) == __CLANG_ATOMIC_INT_LOCK_FREE &&
           __c11_atomic_is_lock_free((long *) 0) == __CLANG_ATOMIC_LONG_LOCK_FREE &&
