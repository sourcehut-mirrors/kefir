...
#define DECL_LOAD(_type) _type test_load_##_type(const _Atomic _type *);
DECL_LOAD(char)
DECL_LOAD(short)
DECL_LOAD(int)
DECL_LOAD(long)
...
#define DECL_STORE(_type) void test_store_##_type(const _Atomic _type *, _type);
DECL_STORE(char)
DECL_STORE(short)
DECL_STORE(int)
DECL_STORE(long)
...
#define DECL_EXCHANGE(_type) _type test_exchange_##_type(const _Atomic _type *, _type);
DECL_EXCHANGE(char)
DECL_EXCHANGE(short)
DECL_EXCHANGE(int)
DECL_EXCHANGE(long)
...
#define DECL_COMPARE_EXCHANGE(_type) _Bool test_compare_exchange_##_type(const _Atomic _type *, _type *, _type);
...
#define DECL_FETCH_OP(_type, _op) _type test_fetch_##_op##_##_type(const _Atomic _type *, _type);
