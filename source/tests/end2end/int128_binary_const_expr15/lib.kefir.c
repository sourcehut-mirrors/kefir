...
unsigned __int128 a =
    ((unsigned __int128) 0xcafebabe0001313244535214uwb) ^ ((unsigned __int128) 0xffeeeccddccdddeeeccddduwb);
...
signed __int128 d = ((signed __int128) 0xeda0323183931wb) ^ ((signed __int128) -1wb);
