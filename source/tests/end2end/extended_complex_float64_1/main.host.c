...
int main(void) {
    assert(f64x_size == sizeof(_Complex long double));
    assert(f64x_alignment == _Alignof(_Complex long double));
    assert(fabsl(creall(*f64x_const_ptr) - 2.71828f) < 1e-6);
    assert(fabsl(cimagl(*f64x_const_ptr) - 9.831f) < 1e-6);
    ...
    int i = 0;
    assert(fabsl(creall(f64x[i]) - ((long double) 3.14159f)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - ((long double) -123.1f)) < 1e-6);
    assert(fabsl(creall(f64x[i]) - (-((long double) 1902.318f))) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - ((long double) 90.4)) < 1e-5);
    _Complex long double exp = ((_Complex long double) 273.3f - 638.1 * I) + ((_Complex long double) 1902.318f + 90.31 * I);
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-4);
    exp = ((_Complex long double) 273.3f - 638.1 * I) - ((_Complex long double) 1902.318f + 90.31 * I);
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-4);
    exp = ((_Complex long double) 273.3f - 638.1 * I) * ((_Complex long double) 1902.318f + 90.31 * I);
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-2);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-1);
    exp = ((_Complex long double) 273.3f - 638.1 * I) / ((_Complex long double) 1902.318f + 90.31 * I);
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-6);
    ...
    exp = (273.3f + 1.21 * I) * ((_Complex long double) 1902.318f - 99.131 * I),
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-2);
    exp = (273.3f + 1.21 * I) / ((_Complex long double) 1902.318f - 99.131 * I),
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-2);
    ...
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-4);
    exp = ((long double) 273.3f - 99.3145 * I) * ((_Complex long double) 1902.318f + 1.0004e6 * I),
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e1);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-2);
    exp = ((long double) 273.3f - 99.3145 * I) / ((_Complex long double) 1902.318f + 1.0004e6 * I);
    assert(fabsl(creall(f64x[i]) - creall(exp)) < 1e-6);
    assert(fabsl(cimagl(f64x[i++]) - cimagl(exp)) < 1e-2);

    _Complex long double res = get64x_1();
    exp = 5.428f - 8842.3 * I;
    ...
    res = neg64x(-42842.31f + 90.56 * I);
    exp = -(-42842.31f + 90.56 * I);
    assert(fabsl(creall(res) - creall(exp)) < 1e-5);
    assert(fabsl(cimagl(res) - cimagl(exp)) < 1e-5);
    res = add64x(-42842.31f + 90.56 * I, 3949.58f - 998.42 * I);
    exp = (-42842.31f + 90.56 * I) + (3949.58f - 998.42 * I);
    assert(fabsl(creall(res) - creall(exp)) < 1e-5);
    assert(fabsl(cimagl(res) - cimagl(exp)) < 1e-5);
    res = sub64x(-42842.31f + 90.56 * I, 3949.58f - 998.42 * I);
    exp = (-42842.31f + 90.56 * I) - (3949.58f - 998.42 * I);
    assert(fabsl(creall(res) - creall(exp)) < 1e-5);
    assert(fabsl(cimagl(res) - cimagl(exp)) < 1e-5);
    res = mul64x(-422.31f + 90.56 * I, 39.58f - 98.42 * I);
    exp = (-422.31f + 90.56 * I) * (39.58f - 98.42 * I);
    assert(fabsl(creall(res) - creall(exp)) < 1e-3);
    assert(fabsl(cimagl(res) - cimagl(exp)) < 1e-3);
    res = div64x(-422.31f + 90.56 * I, 39.58f - 98.42 * I);
    exp = (-422.31f + 90.56 * I) / (39.58f - 98.42 * I);
    assert(fabsl(creall(res) - creall(exp)) < 1e-3);
    assert(fabsl(cimagl(res) - cimagl(exp)) < 1e-3);
