...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    kefir_irbuilder_type_append(mem, floatToDouble_decl->params, KEFIR_IR_TYPE_FLOAT32, 0, 0);
    kefir_irbuilder_type_append(mem, floatToDouble_decl->result, KEFIR_IR_TYPE_FLOAT64, 0, 3);
    struct kefir_ir_function *floatToDouble =
        kefir_ir_module_new_function_with_args(mem, &module, floatToDouble_decl, 1024);
    ...
    kefir_irbuilder_type_append(mem, doubleToFloat_decl->params, KEFIR_IR_TYPE_FLOAT64, 0, 0);
    kefir_irbuilder_type_append(mem, doubleToFloat_decl->result, KEFIR_IR_TYPE_FLOAT32, 0, 3);
    struct kefir_ir_function *doubleToFloat =
        kefir_ir_module_new_function_with_args(mem, &module, doubleToFloat_decl, 1024);
