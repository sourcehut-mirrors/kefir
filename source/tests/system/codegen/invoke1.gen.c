...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    REQUIRE_OK(kefir_ir_module_declare_global(mem, &module, fdbl_decl->name, KEFIR_IR_IDENTIFIER_GLOBAL_DATA));
    ...
    REQUIRE_OK(kefir_ir_module_declare_external(mem, &module, sum10_decl->name, KEFIR_IR_IDENTIFIER_GLOBAL_DATA));
    ...
    REQUIRE_OK(kefir_ir_module_declare_external(mem, &module, fsum_decl->name, KEFIR_IR_IDENTIFIER_GLOBAL_DATA));
    ...
    kefir_irbuilder_block_appendi64(mem, &sumseq->body, KEFIR_IROPCODE_PUSHI64, 1);
    kefir_irbuilder_block_appendi64(mem, &sumseq->body, KEFIR_IROPCODE_IADD64, 0);
    kefir_irbuilder_block_appendi64(mem, &sumseq->body, KEFIR_IROPCODE_PICK, 0);
    kefir_irbuilder_block_appendi64(mem, &sumseq->body, KEFIR_IROPCODE_PUSHI64, 1);
    kefir_irbuilder_block_appendi64(mem, &sumseq->body, KEFIR_IROPCODE_IADD64, 0);
    kefir_irbuilder_block_appendi64(mem, &sumseq->body, KEFIR_IROPCODE_PICK, 0);
    ...
    kefir_irbuilder_block_appendu64(mem, &sumseq->body, KEFIR_IROPCODE_RET, 0);
    ...
    kefir_irbuilder_block_appendu64(mem, &fdbl->body, KEFIR_IROPCODE_RET, 0);
    ...
    REQUIRE_OK(kefir_irbuilder_type_append(mem, fsum_decl_params, KEFIR_IR_TYPE_FLOAT64, 0, 0));
    REQUIRE_OK(kefir_irbuilder_type_append(mem, fsum_decl_result, KEFIR_IR_TYPE_FLOAT64, 0, 0));
