...
kefir_result_t kefir_int_test(struct kefir_mem *mem) {
    ...
    struct kefir_ir_function *fequals = kefir_ir_module_new_function(mem, &module, fequals_decl, 1024);
    ...
    struct kefir_ir_function *fgreater = kefir_ir_module_new_function(mem, &module, fgreater_decl, 1024);
    ...
    struct kefir_ir_function *flesser = kefir_ir_module_new_function(mem, &module, flesser_decl, 1024);
    ...
    struct kefir_ir_function *dequals = kefir_ir_module_new_function(mem, &module, dequals_decl, 1024);
    ...
    struct kefir_ir_function *dgreater = kefir_ir_module_new_function(mem, &module, dgreater_decl, 1024);
    ...
    struct kefir_ir_function *dlesser = kefir_ir_module_new_function(mem, &module, dlesser_decl, 1024);
