...
static kefir_result_t define_assign_function_impl(struct kefir_mem *mem, struct function *func,
    ...
    REQUIRE_OK(kefir_ast_local_context_define_auto(mem, context_manager->local, "ptr", ptr_type, NULL, NULL, NULL, NULL,
                                                   NULL));
    REQUIRE_OK(kefir_ast_local_context_define_auto(mem, context_manager->local, "value", param2_type, NULL, NULL, NULL,
                                                   NULL, NULL));
...
static kefir_result_t generate_ir(struct kefir_mem *mem, struct kefir_ir_module *module,
    ...
    REQUIRE_OK(kefir_ast_struct_type_field(
        ...
        kefir_ast_type_array(mem, context_manager.current->type_bundle, kefir_ast_type_char(), 16, NULL), NULL));
    REQUIRE_OK(kefir_ast_struct_type_field(
