...
static kefir_result_t define_conditional_function(struct kefir_mem *mem, struct function *func,
    ...
    struct kefir_ast_node_base *inner_loop =
        KEFIR_AST_NODE_BASE(kefir_ast_new_while_statement_noarena(mem, inner_condition, inner_body));
    ...
    struct kefir_ast_node_base *outer_loop =
        KEFIR_AST_NODE_BASE(kefir_ast_new_while_statement_noarena(mem, outer_condition, KEFIR_AST_NODE_BASE(outer_body)));
