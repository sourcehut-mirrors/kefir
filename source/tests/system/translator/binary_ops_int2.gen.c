...
#define DEFFUN(_id, _name, _oper)                                                                                     \
    static kefir_result_t define_##_id##_function(struct kefir_mem *mem, struct function *func,                       \
        ...
        REQUIRE_OK(kefir_ast_local_context_define_auto(mem, context_manager->local, "x",                              \
                                                       kefir_ast_type_unsigned_int(), NULL, NULL, NULL, NULL, NULL)); \
        ...
        func->body = KEFIR_AST_NODE_BASE(kefir_ast_new_binary_operation_noarena(                                              \
            mem, (_oper), KEFIR_AST_NODE_BASE(kefir_ast_new_identifier_noarena(mem, context_manager->current->symbols, "x")), \
            KEFIR_AST_NODE_BASE(kefir_ast_new_identifier_noarena(mem, context_manager->current->symbols, "y"))));             \
                                                                                                                      \
