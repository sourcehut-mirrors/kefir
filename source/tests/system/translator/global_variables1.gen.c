...
static kefir_result_t define_variables(struct kefir_mem *mem, const struct kefir_ast_context *context,
    ...
    struct kefir_ast_declaration *decl1 = kefir_ast_new_single_declaration_noarena(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_char_noarena(mem, 'B'))), NULL);
    ...
    struct kefir_ast_declaration *decl2 = kefir_ast_new_single_declaration_noarena(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_int_noarena(mem, 0x4efd))), NULL);
    ...
    struct kefir_ast_declaration *decl3 = kefir_ast_new_single_declaration_noarena(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_long_noarena(mem, -100000))),
        NULL);
    ...
    struct kefir_ast_declaration *decl4 = kefir_ast_new_single_declaration_noarena(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_float_noarena(mem, 7.6549f))),
        NULL);
    ...
    struct kefir_ast_declaration *decl5 = kefir_ast_new_single_declaration_noarena(
        ...
        kefir_ast_new_expression_initializer_noarena(mem, KEFIR_AST_NODE_BASE(kefir_ast_new_constant_double_noarena(mem, 0.547e-9))),
        NULL);
    ...
    REQUIRE_OK(kefir_ast_declarator_specifier_list_append(mem, &decl12->specifiers,
                                                          kefir_ast_storage_class_specifier_extern(mem, NULL)));
    REQUIRE_OK(
        kefir_ast_declarator_specifier_list_append(mem, &decl12->specifiers, kefir_ast_type_specifier_void(mem, NULL)));
