...
KEFIR_EXTERNAL_TEST_WGET_ARCHIVE_FILENAME := $(WGET)2-$(KEFIR_EXTERNAL_TEST_WGET_VERSION).tar.gz
KEFIR_EXTERNAL_TEST_WGET_ARCHIVE := $(KEFIR_EXTERNAL_TEST_WGET_DIR)/$(KEFIR_EXTERNAL_TEST_WGET_ARCHIVE_FILENAME)
KEFIR_EXTERNAL_TEST_WGET_SOURCE_DIR := $(KEFIR_EXTERNAL_TEST_WGET_DIR)/$(WGET)2-$(KEFIR_EXTERNAL_TEST_WGET_VERSION)
KEFIR_EXTERNAL_TEST_WGET_URL := https://ftp.gnu.org/gnu/$(WGET)/$(WGET)2-$(KEFIR_EXTERNAL_TEST_WGET_VERSION).tar.gz
...
$(KEFIR_EXTERNAL_TEST_WGET_SOURCE_DIR)/src/$(WGET)2: $(KEFIR_EXTERNAL_TEST_WGET_SOURCE_DIR)/Makefile
...
$(KEFIR_EXTERNAL_TEST_WGET_DIR)/tests.log: $(KEFIR_EXTERNAL_TEST_WGET_SOURCE_DIR)/src/$(WGET)2
