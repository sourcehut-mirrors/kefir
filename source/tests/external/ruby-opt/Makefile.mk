...
KEFIR_EXTERNAL_TEST_RUBY_OPT_VERSION := 3.4.5
KEFIR_EXTERNAL_TEST_RUBY_OPT_VERSION_UNDERSCORE := $(subst .,_,$(KEFIR_EXTERNAL_TEST_RUBY_OPT_VERSION))
KEFIR_EXTERNAL_TEST_RUBY_OPT_ARCHIVE_FILENAME := v$(KEFIR_EXTERNAL_TEST_RUBY_OPT_VERSION_UNDERSCORE).tar.gz
KEFIR_EXTERNAL_TEST_RUBY_OPT_ARCHIVE := $(KEFIR_EXTERNAL_TEST_RUBY_OPT_DIR)/$(KEFIR_EXTERNAL_TEST_RUBY_OPT_ARCHIVE_FILENAME)
KEFIR_EXTERNAL_TEST_RUBY_OPT_SOURCE_DIR := $(KEFIR_EXTERNAL_TEST_RUBY_OPT_DIR)/ruby-$(KEFIR_EXTERNAL_TEST_RUBY_OPT_VERSION_UNDERSCORE)
KEFIR_EXTERNAL_TEST_RUBY_URL := https://github.com/ruby/ruby/archive/refs/tags/$(KEFIR_EXTERNAL_TEST_RUBY_OPT_ARCHIVE_FILENAME)

KEFIR_EXTERNAL_TEST_RUBY_OPT_ARCHIVE_SHA256 := 0c0680e4bce7a709208009506e286fd387cd16f290f00606133f735943ab75d5
