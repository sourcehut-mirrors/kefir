...
KEFIR_EXTERNAL_TEST_MUON_VERSION := 0.3.1
...
KEFIR_EXTERNAL_TEST_MUON_ARCHIVE_SHA256 := 45f6ad728946a0788188004e3a88a77a7d07b48525ce0646430589d1db4c832e
...
$(KEFIR_EXTERNAL_TEST_MUON_SOURCE_DIR)/build/muon: $(KEFIR_EXTERNAL_TEST_MUON_SOURCE_DIR)/.extracted $(KEFIR_EXE)
...
$(KEFIR_EXTERNAL_TEST_MUON_SOURCE_DIR)/build2/build.ninja: $(KEFIR_EXTERNAL_TEST_MUON_SOURCE_DIR)/build/muon
	@echo "Setting muon $(KEFIR_EXTERNAL_TEST_MUON_VERSION) up..."
	@cd "$(KEFIR_EXTERNAL_TEST_MUON_SOURCE_DIR)" && \
		LD_LIBRARY_PATH="$(realpath $(LIB_DIR)):$$LD_LIBRARY_PATH" \
		KEFIR_RTINC="$(realpath $(HEADERS_DIR))/kefir/runtime" \
		CC="$(realpath $(KEFIR_EXE))" \
		build/muon setup build2
