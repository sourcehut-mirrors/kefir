...
#define CODEGEN(name, field)                                                                 \
    ...
    SIMPLE(0, "error-compiler-ref", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           true, features.error_compiler_ref),
    SIMPLE(0, "no-error-compiler-ref", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           false, features.error_compiler_ref),
    ...
    SIMPLE(0, "codegen-decimal-bid", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, KEFIR_COMPILER_RUNNER_DECIMAL_ENCODING_BID,
           codegen.decimal_encoding),
    SIMPLE(0, "codegen-decimal-dpd", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, KEFIR_COMPILER_RUNNER_DECIMAL_ENCODING_DPD,
           codegen.decimal_encoding),
