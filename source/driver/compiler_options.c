...
#define CODEGEN(name, field)                                                                 \
    ...
    SIMPLE(0, "error-compiler-ref", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, true, features.error_compiler_ref),
    SIMPLE(0, "no-error-compiler-ref", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, false,
           features.error_compiler_ref),
    ...
    SIMPLE(0, "no-opt-cx-limited-range", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, false,
           optimizer.cx_limited_range),
    ...
    SIMPLE(0, "optimizer-max-inlines-per-caller", true, KEFIR_CLI_OPTION_ACTION_ASSIGN_UINTARG, 0,
           optimizer.max_inlines_per_caller),
    SIMPLE(0, "optimizer-inline-caller-blocks", true, KEFIR_CLI_OPTION_ACTION_ASSIGN_UINTARG, 0,
           optimizer.max_inline_caller_blocks),
    SIMPLE(0, "optimizer-inline-callee-instr", true, KEFIR_CLI_OPTION_ACTION_ASSIGN_UINTARG, 0,
           optimizer.max_inline_callee_instructions),
    SIMPLE(0, "optimizer-inline-leaf-callee-instr", true, KEFIR_CLI_OPTION_ACTION_ASSIGN_UINTARG, 0,
           optimizer.max_inline_leaf_callee_instructions),
    ...
    FEATURE("freestanding", features.freestanding),
    ...
    SIMPLE(0, "no-declare-atomic-support", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, false,
           features.declare_atomic_support),
    SIMPLE(0, "declare-decimal-support", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, true,
           features.declare_decimal_support),
    SIMPLE(0, "no-declare-decimal-support", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, false,
           features.declare_decimal_support),
    SIMPLE(0, "declare-decimal-bitint-conv-support", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, true,
           features.declare_decimal_bitint_conv_support),
    SIMPLE(0, "no-declare-decimal-bitint-conv-support", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, false,
           features.declare_decimal_bitint_conv_support),
    ...
    SIMPLE(0, "no-optimize-stack-frame", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT, false,
           features.optimize_stack_frame),
    SIMPLE(0, "max-parser-errors", true, KEFIR_CLI_OPTION_ACTION_ASSIGN_UINTARG, 0, features.max_parser_errors),
    SIMPLE(0, "max-analyzer-errors", true, KEFIR_CLI_OPTION_ACTION_ASSIGN_UINTARG, 0, features.max_analyzer_errors),
    ...
    SIMPLE(0, "codegen-decimal-default", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_COMPILER_RUNNER_DECIMAL_ENCODING_DEFAULT, codegen.decimal_encoding),
    SIMPLE(0, "codegen-decimal-bid", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_COMPILER_RUNNER_DECIMAL_ENCODING_BID, codegen.decimal_encoding),
    SIMPLE(0, "codegen-decimal-dpd", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_COMPILER_RUNNER_DECIMAL_ENCODING_DPD, codegen.decimal_encoding),
    SIMPLE(0, "codegen-tentative-common", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_AST_CONTEXT_TENTATIVE_DEFINITION_PLACEMENT_COMMON, codegen.tentative_definition_placement),
    SIMPLE(0, "codegen-tentative-no-common", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_AST_CONTEXT_TENTATIVE_DEFINITION_PLACEMENT_NO_COMMON, codegen.tentative_definition_placement),
    SIMPLE(0, "codegen-visibility-default", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_AST_DECLARATOR_VISIBILITY_DEFAULT, codegen.symbol_visibility),
    SIMPLE(0, "codegen-visibility-protected", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_AST_DECLARATOR_VISIBILITY_PROTECTED, codegen.symbol_visibility),
    SIMPLE(0, "codegen-visibility-hidden", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
           KEFIR_AST_DECLARATOR_VISIBILITY_HIDDEN, codegen.symbol_visibility),
    SIMPLE(0, "codegen-visibility-internal", false, KEFIR_CLI_OPTION_ACTION_ASSIGN_CONSTANT,
